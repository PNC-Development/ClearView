...
namespace NCC.ClearView.Application.Core
{
    public class VirtualCPU
	{
        ...
        public VirtualCPU(int _user, string _dsn)
		{
			user = _user;
			dsn = _dsn;
		}
        public DataSet Gets(int _enabled)
        {
            ...
            return SqlHelper.ExecuteDataset(dsn, CommandType.StoredProcedure, "pr_getVirtualCPUs", arParams);
        }
        public DataSet GetVMwares(int _xp, int _win7, int _enabled)
        {
            ...
            return SqlHelper.ExecuteDataset(dsn, CommandType.StoredProcedure, "pr_getVirtualCPUsVMware", arParams);
        }
        public DataSet GetVirtuals(int _enabled)
        {
            arParams = new SqlParameter[1];
            arParams[0] = new SqlParameter("@enabled", _enabled);
            return SqlHelper.ExecuteDataset(dsn, CommandType.StoredProcedure, "pr_getVirtualCPUsVirtual", arParams);
        }
        public DataSet Get(int _id)
        {
            arParams = new SqlParameter[1];
            arParams[0] = new SqlParameter("@id", _id);
            return SqlHelper.ExecuteDataset(dsn, CommandType.StoredProcedure, "pr_getVirtualCPU", arParams);
        }
        ...
        public void Add(string _name, double _value, int _vmware, int _virtual, int _xp, int _win7, int _default, string _prompt, int _display, int _enabled)
        {
            ...
            SqlHelper.ExecuteNonQuery(dsn, CommandType.StoredProcedure, "pr_addVirtualCPU", arParams);
		}
        public void Update(int _id, string _name, double _value, int _vmware, int _virtual, int _xp, int _win7, int _default, string _prompt, int _enabled)
        {
            ...
            arParams[9] = new SqlParameter("@enabled", _enabled);
            SqlHelper.ExecuteNonQuery(dsn, CommandType.StoredProcedure, "pr_updateVirtualCPU", arParams);
        }
        public void UpdateOrder(int _id, int _display)
        {
            ...
            SqlHelper.ExecuteNonQuery(dsn, CommandType.StoredProcedure, "pr_updateVirtualCPUOrder", arParams);
        }
        public void Enable(int _id, int _enabled)
        {
            ...
            SqlHelper.ExecuteNonQuery(dsn, CommandType.StoredProcedure, "pr_updateVirtualCPUEnabled", arParams);
        }
        public void Delete(int _id)
        {
            arParams = new SqlParameter[1];
            arParams[0] = new SqlParameter("@id", _id);
            SqlHelper.ExecuteNonQuery(dsn, CommandType.StoredProcedure, "pr_deleteVirtualCPU", arParams);
        }
    }
}
