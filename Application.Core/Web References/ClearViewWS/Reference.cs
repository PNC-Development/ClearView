...
namespace NCC.ClearView.Application.Core.ClearViewWS {
    using System;
    ...
    public partial class ClearViewWebServices : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback GetVMwarePathOperationCompleted;
        
        private bool useDefaultCredentialsSetExplicitly;
        
        /// <remarks/>
        public ClearViewWebServices() {
            this.Url = global::NCC.ClearView.Application.Core.Properties.Settings.Default.NCC_ClearView_Application_Core_ClearViewWS_ClearViewWebServices;
        ...
        /// <remarks/>
        public event GetVMwarePathCompletedEventHandler GetVMwarePathCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetVMwarePath", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string GetVMwarePath(string Name, string URL, string Token) {
            object[] results = this.Invoke("GetVMwarePath", new object[] {
                        Name,
                        URL,
                        Token});
            return ((string)(results[0]));
        ...
        /// <remarks/>
        public void GetVMwarePathAsync(string Name, string URL, string Token) {
            this.GetVMwarePathAsync(Name, URL, Token, null);
        }
        
        /// <remarks/>
        public void GetVMwarePathAsync(string Name, string URL, string Token, object userState) {
            if ((this.GetVMwarePathOperationCompleted == null)) {
                this.GetVMwarePathOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetVMwarePathOperationCompleted);
            }
            this.InvokeAsync("GetVMwarePath", new object[] {
                        Name,
                        URL,
                        Token}, this.GetVMwarePathOperationCompleted, userState);
        }
        
        private void OnGetVMwarePathOperationCompleted(object arg) {
            if ((this.GetVMwarePathCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetVMwarePathCompleted(this, new GetVMwarePathCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.18408")]
    public delegate void GetVMwarePathCompletedEventHandler(object sender, GetVMwarePathCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.18408")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetVMwarePathCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetVMwarePathCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
