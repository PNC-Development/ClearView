...
<script runat="server">
    ...
    private void Page_Load()
    {
        ...
        string strConnect = oVMWare.ConnectDEBUG("https://wdsvt100a/sdk", 999, "PNC-Dalton");
        if (strConnect == "")
        {
            VimService _service = oVMWare.GetService();
            ServiceContent _sic = oVMWare.GetSic();
            string strName = "AVAMAR_TEST_HEALY";
            string strVLAN = "dvPortGroup2560";
            ...
            //{
                ...
                //{
                    ...
                    //deviceSpec[0].operation = VirtualDeviceConfigSpecOperation.remove;
