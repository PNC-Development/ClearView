<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AAA template.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.AAAtemplate" %>
                ...
                <asp:Panel id="panAdd" runat="server" Visible="false">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        ...
                        <tr> 
                            ...
                            <td><asp:Button ID="btnWindow" runat="server" Text="Open New Window" Width="150" CssClass="default" /></td>
                        </tr>
                        <tr> 
                            <td class="cmdefault">&nbsp;</td>
