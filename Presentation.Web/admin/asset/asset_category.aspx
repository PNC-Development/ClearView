<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="asset_category.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.asset_category" %>
                        ...
                        <tr>
                            <td>
                                <asp:repeater ID="rptView" runat="server">
                                    ...
                                    <ItemTemplate>
                                        <tr bgcolor="#EFEFEF" onmouseover="AdminMouseOver(this);" onmouseout="AdminMouseOut(this);" onclick="if(event.srcElement.tagName != 'INPUT')Edit('<%# DataBinder.Eval(Container.DataItem, "id") %>','<%# DataBinder.Eval(Container.DataItem, "AssetCategoryName") %>','<%# DataBinder.Eval(Container.DataItem, "enabled") %>');" class="default">
                                            ...
                                            <td width="50%">&nbsp;<%# DataBinder.Eval(Container.DataItem, "AssetCategoryName") %></td>
