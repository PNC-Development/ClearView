<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="asset_depot.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.asset_depot" %>
...
<script type="text/javascript">
    ...
    var oEnabled = null;
    function Edit(strId, strName,strlocationId,strlocation, strEnabled) {
    ...
    function Load() {
        ...
        oLocationId = document.getElementById('<%=hdnLocation.ClientID%>');
...
<table width="98%" cellpadding="0" cellspacing="0" border="0" align="center">
		...
		<tr> 
		    <td><b>Asset Stock Locations</b></td>
                                    ...
                                    <HeaderTemplate>
                                        <table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
                                            <tr bgcolor="#CCCCCC">
                                                ...
                                                <td width="50%" class="bold"><asp:linkbutton ID="lnkLocation" Text="Name" CommandArgument="Location" CssClass="bold" OnClick="OrderView" runat="server"/></td>
