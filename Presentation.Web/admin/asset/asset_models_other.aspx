<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="asset_models_other.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.asset_models_other" %>
...
<table width="98%" cellpadding="0" cellspacing="0" border="0" align="center">
		...
		<tr> 
		    <td><b>Asset Model Properties - Other</b></td>
                            ...
                            <td colspan="2" bgcolor="#F6F6F6" style="border:solid 1px #CCCCCC">
                                <table width="100%" cellpadding="2" cellspacing="2" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td width="100%"><asp:CheckBox ID="chk_inventory" runat="server" CssClass="default" /></td>
                                    </tr>
                                    <tr>
                                        <td nowrap>Dell:</td>
