<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="audit_script_languages.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.audit_script_languages" %>
...
<table width="98%" cellpadding="0" cellspacing="0" border="0" align="center">
		...
		<tr> 
		    <td><b>Audit Script Languages</b></td>
		    ...
		    <td colspan="2" align="center">
                ...
                <asp:Panel id="panAdd" runat="server" Visible="false">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        ...
                        <tr> 
                            <td class="default">EXE:</td>
                            <td><asp:textbox ID="txtEXE" CssClass="default" runat="server" Width="600" MaxLength="200"/></td>
                        </tr>
                        <tr> 
                            <td class="default">Extension:</td>
                            <td><asp:textbox ID="txtExtension" CssClass="default" runat="server" Width="50" MaxLength="10"/></td>
                        </tr>
                        <tr> 
                            <td class="default"></td>
                            <td>
                                <table width="100%" cellpadding="3" cellspacing="2" border="0">
                                    <tr>
                                        <td colspan="2">The working directory should be the location of the script.  For example, if the script is located at C:\Temp\script.exe, the working directory should be &quot;C:\Temp\&quot; and the EXE should be &quot;script.exe&quot;.</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">Here is a list of popular working directories...if you are referencing any of these, be sure to use the proper variable.</td>
                                    </tr>
                                    <tr>
                                        <td nowrap><b>Directory</b></td>
                                        <td width="100%"><b>Variable</b></td>
                                    </tr>
                                    <tr>
                                        <td nowrap>Windows Directory (C:\WINDOWS, C:\WINNT)</td>
                                        <td width="100%">%WinDir%</td>
                                    </tr>
                                    <tr>
                                        <td nowrap>System Drive (C:\)</td>
                                        <td width="100%">%SystemDrive%</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">An example of this would be a script located at C:\WINDOWS\SYSTEM32\script.exe, the working directory should be &quot;%SystemDirectory%&quot; and the EXE should be &quot;script.exe&quot;.</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
