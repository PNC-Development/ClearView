<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bypass.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.bypass" %>
...
<script type="text/javascript">
    function UpdateCompleteCheck(oCheck) {
        if (oCheck.checked == true) {
            alert('This asset has already been marked COMPLETE meaning it is done with the decommission process.\n\nYou cannot bypass the cooldown for an asset that is already complete.');
...
<table width="98%" cellpadding="0" cellspacing="0" border="0" align="center">
		...
		<tr> 
		    <td><b>Bypass Cooldown for Decom(s)</b></td>
		    <td align="right"></td>
		</tr>
		<tr><td colspan="2">&nbsp;</td></tr>
		<tr>
                ...
                <div ID="divView" runat="server" style="display:inline">
                    ...
                    <asp:Panel ID="panResult" runat="server" Visible="false">
                                ...
                                <td colspan="2">
                                    <table width="100%" cellpadding="3" cellspacing="0" border="0" align="center" style="border:solid 1px #CCCCCC">
                                        ...
                                        <asp:repeater ID="rptDevices" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    <td valign="top"><asp:CheckBox ID="chkDevice" runat="server" CssClass="default" ToolTip='<%# DataBinder.Eval(Container.DataItem, "serverid").ToString() %>' /></td>
                                                    ...
                                                    <td colspan="5">
                                                        <table cellpadding="4" cellspacing="0" border="0">
                                                            <tr>
                                                                ...
                                                                <td class="bold"><%# DataBinder.Eval(Container.DataItem, "destroy") %></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Decommission Completed:</td>
                                                                <td><asp:Label ID="lblTurnedOff" runat="server" CssClass="default" Text='<%# DataBinder.Eval(Container.DataItem, "turnedoff") %>' /></td>
                                                                <td><img src="/images/spacer.gif" border="0" width="50" height="1" /></td>
                                                                <td>Destroy / Redeploy Completed:</td>
                                                                <td><asp:Label ID="lblDestroyed" runat="server" CssClass="redbold" Text='<%# DataBinder.Eval(Container.DataItem, "destroyed") %>' /></td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="5"><asp:Label ID="lblBypassed" runat="server" CssClass="default" Text='<%# DataBinder.Eval(Container.DataItem, "bypassed") %>' ToolTip='<%# DataBinder.Eval(Container.DataItem, "bypassed_by").ToString() + "_" + DataBinder.Eval(Container.DataItem, "bypassed_ptm").ToString() + "_" + DataBinder.Eval(Container.DataItem, "bypassed_reason").ToString() %>' /></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                        ...
                        <table width="95%" border="0" cellspacing="2" cellpadding="3" align="center">
                            ...
                            <tr>
                                <td nowrap>New Date:</td>
                                <td width="100%"><asp:TextBox ID="txtDate" runat="server" CssClass="default" Width="75" MaxLength="10" /></td>
                            </tr>
                            <tr>
                                <td nowrap>Change Control:</td>
                                <td width="100%"><asp:TextBox ID="txtPTM" runat="server" CssClass="default" Width="100" MaxLength="20" /></td>
                            </tr>
                            <tr>
                                <td nowrap>Reason:</td>
