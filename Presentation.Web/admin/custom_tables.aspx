<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="custom_tables.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.custom_tables" %>
                                ...
                                <asp:repeater ID="rptView" runat="server">
                                    <HeaderTemplate>
                                        <table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
                                            <tr bgcolor="#CCCCCC">
                                                <td class="bold">&nbsp;</td>
                                                <td width="50%" class="bold"><asp:linkbutton ID="lnkName" Text="Name" CommandArgument="tablename" CssClass="bold" OnClick="OrderView" runat="server"/></td>
                                    ...
                                    <ItemTemplate>
                                        <tr bgcolor="#EFEFEF" onmouseover="AdminMouseOver(this);" onmouseout="AdminMouseOut(this);" onclick="if(event.srcElement.tagName != 'INPUT')Edit('<%# DataBinder.Eval(Container.DataItem, "id") %>','<%# DataBinder.Eval(Container.DataItem, "tablename") %>','<%# DataBinder.Eval(Container.DataItem, "enabled") %>');" class="default">
                                            ...
                                            <td width="50%">&nbsp;<%# DataBinder.Eval(Container.DataItem, "tablename") %></td>
                ...
                <div id="divAdd" runat="server" style="display:none">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        <tr> 
                            ...
                            <td><asp:textbox ID="txtName" CssClass="default" runat="server" Width="300" MaxLength="50"/>&nbsp;&nbsp;<asp:Button ID="btnTable" runat="server" CssClass="default" Width="25" Text="..." /></td>
                        </tr>
                        <tr> 
                        ...
                        <tr> 
                            ...
                            <td><asp:Button ID="btnItems" runat="server" Text="Custom Memberships" Width="150" CssClass="default" /></td>
                        </tr>
                        <tr> 
                            <td class="cmdefault">&nbsp;</td>
                            <td><asp:Button ID="btnPopulate" runat="server" Text="Populate Fields" Width="150" CssClass="default" OnClick="btnPopulate_Click" /></td>
                        </tr>
