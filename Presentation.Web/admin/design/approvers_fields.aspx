<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="approvers_fields.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.design_approvers_fields" %>
...
<table width="98%" cellpadding="0" cellspacing="0" border="0" align="center">
		...
		<tr> 
		    <td><b>Design Approvers (Related to Fields)</b></td>
                                ...
                                <asp:repeater ID="rptView" runat="server">
                                    <HeaderTemplate>
                                        <table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
                                            <tr bgcolor="#CCCCCC">
                                                <td class="bold">&nbsp;</td>
                                                <td width="50%" class="bold"><asp:linkbutton ID="lnkField" Text="Field" CommandArgument="related_field" CssClass="bold" OnClick="OrderView" runat="server"/></td>
                                    ...
                                    <ItemTemplate>
                                        <tr bgcolor="#EFEFEF" onmouseover="AdminMouseOver(this);" onmouseout="AdminMouseOut(this);" onclick="if(event.srcElement.tagName != 'INPUT')window.navigate('<%# Request.Path + "?id=" + DataBinder.Eval(Container.DataItem, "id")%>');" class="default">
                                            ...
                                            <td width="50%">&nbsp;<%# DataBinder.Eval(Container.DataItem, "related_field")%></td>
                ...
                <asp:Panel id="panAdd" runat="server" Visible="false">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        <tr>
                            ...
                            <td><asp:DropDownList ID="ddlFields" runat="server" /> (The field in CV_DESIGNS table that contains the USERID of the approver)</td>
                        </tr>
                        <tr> 
