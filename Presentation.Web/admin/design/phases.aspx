<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="phases.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.design_phases" %>
                                ...
                                <asp:repeater ID="rptView" runat="server">
                                    <HeaderTemplate>
                                        <table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
                                            <tr bgcolor="#CCCCCC">
                                                <td class="bold">&nbsp;</td>
                                                <td width="50%" class="bold"><asp:linkbutton ID="lnkTitle" Text="Title" CommandArgument="title" CssClass="bold" OnClick="OrderView" runat="server"/></td>
                ...
                <asp:Panel id="panAdd" runat="server" Visible="false">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        <tr> 
                            ...
                            <td><asp:TextBox ID="txtTitle" CssClass="default" runat="server" Width="300" MaxLength="50"/></td>
                        </tr>
                        <tr> 
                            <td class="default">Description:<br /><br />(Can be HTML)</td>
                            <td><asp:TextBox ID="txtDescription" CssClass="default" runat="server" Width="400" Rows="10" TextMode="multiLine"/></td>
                        </tr>
                        <tr> 
                            <td class="default">Help:<br /><br />(Can be HTML)</td>
                            <td><asp:TextBox ID="txtHelp" CssClass="default" runat="server" Width="400" Rows="10" TextMode="multiLine"/></td>
                        </tr>
                        <tr> 
                        ...
                        <tr> 
                            <td class="cmdefault">&nbsp;</td>
                            <td><asp:Literal ID="litConfiguration" runat="server" /></td>
                        </tr>
                    </table>
                </asp:Panel>
            </td>
