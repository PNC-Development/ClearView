<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="did_you_knows.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.did_you_knows" %>
...
<table width="98%" cellpadding="0" cellspacing="0" border="0" align="center">
		...
		<tr> 
		    <td><b>Did You Know's</b></td>
		    <td align="right"><asp:LinkButton ID="btnNew" runat="server" CssClass="cmlink" Text="Add New" OnClick="btnNew_Click" /></td>
		</tr>
		<tr><td colspan="2">&nbsp;</td></tr>
		<tr>
                                ...
                                <asp:repeater ID="rptView" runat="server">
                                    <HeaderTemplate>
                                        <table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
                                            <tr bgcolor="#CCCCCC">
                                                <td class="bold">&nbsp;</td>
                                                <td width="50%" class="bold"><asp:linkbutton ID="lnkName" Text="Description" CommandArgument="description" CssClass="bold" OnClick="OrderView" runat="server"/></td>
                                    ...
                                    <ItemTemplate>
                                        <tr bgcolor="#EFEFEF" class="default">
                                            ...
                                            <td width="50%">&nbsp;<asp:LinkButton ID="btnEdit" OnClick="btnEdit_Click" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "description") %>' CommandArgument='<%# DataBinder.Eval(Container.DataItem, "id") %>' /></td>
                ...
                <asp:Panel ID="panEdit" runat="server" Visible="false">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        <tr> 
                            ...
                            <td><asp:textbox ID="txtDescription" CssClass="default" runat="server" Width="100%" Rows="20" TextMode="MultiLine"/></td>
                        </tr>
