<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dns_types.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.dns_types" %>
...
<script type="text/javascript">
    ...
    var oHdnParent = null;
    var oEnabled = null;
    function Edit(strId, strName, strValue, strEnabled) {
		    ...
		    <td colspan="2" align="center">
                ...
                <div id="divAdd" runat="server" style="display:none">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        ...
                        <tr> 
                            <td class="default" width="100px">Value:</td>
                            <td><asp:textbox ID="txtValue" CssClass="default" runat="server" Width="300" MaxLength="100"/></td>
                        </tr>
                        <tr> 
