<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="domain_controllers.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.domain_controllers" %>
...
<script type="text/javascript">
    ...
    var oEnabled = null;
    function Edit(strId, strName, strEnvironment, strEnabled) {
                        ...
                        <tr> 
                            ...
                            <td>
                                <asp:DropDownList ID="ddlEnvironment" CssClass="default" runat="server">
                                    <asp:ListItem Text="Development" Value="2" />
                                    <asp:ListItem Text="Test" Value="3" />
                                    <asp:ListItem Text="Production" Value="4" />
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr> 
