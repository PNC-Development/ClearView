<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="domains_admin_groups.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.domains_admin_groups" %>
...
<script type="text/javascript">
    ...
    var oName = null;
    var oEnabled = null;
    function Edit(strId, strParent, strName, strEnabled) {
    ...
    function Load() {
        ...
        oParent = document.getElementById('<%=ddlDomain.ClientID%>');
                ...
                <div id="divAdd" runat="server" style="display:none">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        <tr> 
                            ...
                            <td><asp:dropdownlist ID="ddlDomain" CssClass="default" runat="server"/></td>
                        </tr>
                        <tr> 
