<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="enhancement_approval_groups.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.enhancement_approval_groups" %>
...
<table width="98%" cellpadding="0" cellspacing="0" border="0" align="center">
		...
		<tr> 
		    <td><b>Enhancement Approval Groups</b></td>
		    ...
		    <td colspan="2" align="center">
                ...
                <asp:Panel id="panAdd" runat="server" Visible="false">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        ...
                        <tr> 
                            <td class="default">Approval:</td>
                            <td>
                                <asp:RadioButton ID="radAny" runat="server" GroupName="Type" Text="Any approval will allow the enhancement to proceed" /><br />
                                <asp:RadioButton ID="radAll" runat="server" GroupName="Type" Text="All approvers must approve for the enhancement to proceed" Checked="true" /><br />
                            </td>
                        </tr>
                        <tr> 
                        ...
                        <tr> 
                            ...
                            <td><asp:Button ID="btnUsers" runat="server" Text="Edit Approvers" Width="100" CssClass="default" /></td>
                        </tr>
