<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="environments.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.environments" %>
...
<script type="text/javascript">
    ...
    var oPNCDomain = null;
    var oEnabled = null;
    function Edit(strId, strName, strForecast, strEcom, strNCBDomain, strPNCDomain, strEnabled) {
        ...
        oEcom.checked = (strEcom == "1");
        oNCBDomain.value = strNCBDomain;
        oPNCDomain.value = strPNCDomain;
    ...
    function Load() {
        ...
        oEcom = document.getElementById('<%=chkEcom.ClientID%>');
        oNCBDomain = document.getElementById('<%=txtNCBDomain.ClientID%>');
        oPNCDomain = document.getElementById('<%=txtPNCDomain.ClientID%>');
		    ...
		    <td colspan="2" align="center">
                        ...
                        <tr>
                            <td>
                                <asp:repeater ID="rptView" runat="server">
                                    ...
                                    <ItemTemplate>
                                        <tr bgcolor="#EFEFEF" onmouseover="AdminMouseOver(this);" onmouseout="AdminMouseOut(this);" onclick="if(event.srcElement.tagName != 'INPUT')Edit('<%# DataBinder.Eval(Container.DataItem, "id") %>','<%# DataBinder.Eval(Container.DataItem, "name") %>','<%# DataBinder.Eval(Container.DataItem, "forecast") %>','<%# DataBinder.Eval(Container.DataItem, "ecom") %>','<%# DataBinder.Eval(Container.DataItem, "ncb_domain") %>','<%# DataBinder.Eval(Container.DataItem, "pnc_domain") %>','<%# DataBinder.Eval(Container.DataItem, "enabled") %>');" class="default">
                ...
                <div id="divAdd" runat="server" style="display:none">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        ...
                        <tr> 
                            <td class="default">Forecast:</td>
                            <td><asp:CheckBox ID="chkForecast" runat="server" Checked="true" /></td>
                        </tr>
                        <tr> 
                            <td class="default">E-Commerce:</td>
                            <td><asp:CheckBox ID="chkEcom" runat="server" Checked="true" /></td>
                        </tr>
                        <tr> 
                            <td class="default">NCB Domain:</td>
                            <td><asp:TextBox ID="txtNCBDomain" runat="server" CssClass="default" Width="200" MaxLength="50" /></td>
                        </tr>
                        <tr> 
                            <td class="default">PNC Domain:</td>
                            <td><asp:TextBox ID="txtPNCDomain" runat="server" CssClass="default" Width="200" MaxLength="50" /></td>
                        </tr>
                        <tr> 
