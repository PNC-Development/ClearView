<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forecast_steps_additional.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.forecast_steps_additional" %>
...
<script type="text/javascript">
    ...
    var oPath = null;
    var oEnabled = null;
    function Edit(strId, strName, strPath, strEnabled) {
...
<table width="98%" cellpadding="0" cellspacing="0" border="0" align="center">
		...
		<tr> 
		    <td><b>Forecast Steps (Additional)</b></td>
                                ...
                                <asp:repeater ID="rptView" runat="server">
                                    <HeaderTemplate>
                                        <table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
                                            <tr bgcolor="#CCCCCC">
                                                <td class="bold">&nbsp;</td>
                                                <td width="50%" class="bold"><asp:linkbutton ID="lnkName" Text="Code" CommandArgument="code" CssClass="bold" OnClick="OrderView" runat="server"/></td>
