<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frame_asset_submodel_browser.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.frame_asset_submodel_browser" %>
    ...
    <tr height="1">
        <td colspan="2">
            <table width="100%" border="0" cellSpacing="2" cellPadding="2" bgcolor="#e6e9f0">
	            <tr bgcolor="#e6e9f0">
		            <td><b>Asset SubModel Browser</b></td>
	                <td align="right">
    ...
    <tr>
        <td colspan="2">
            ...
            <table width="100%" height="100%" border="0" cellSpacing="2" cellPadding="2" bgcolor="#c8cfdd">
	            <tr height="1">
	                <td colspan="2">SubModel:&nbsp;<asp:TextBox ID="txtName" runat="server" CssClass="error" Width="100%" ReadOnly="true" /></td>
                </tr>
	            <tr>
