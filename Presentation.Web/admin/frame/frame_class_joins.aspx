<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frame_class_joins.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.frame_class_joins" %>
    ...
    <tr height="1">
        <td colspan="2">
            <table width="100%" border="0" cellSpacing="2" cellPadding="2" bgcolor="#e6e9f0">
	            <tr bgcolor="#e6e9f0">
		            <td><b><asp:Label ID="lblName" runat="server" CssClass="default" /> Joins</b></td>
	                <td align="right">
    ...
    <tr height="1">
        <td colspan="2">
            <table width="100%" border="0" cellSpacing="2" cellPadding="2">
	            <tr>
		            <td>Name:</td>
	                <td><asp:TextBox ID="txtName" runat="server" CssClass="default" Width="200" MaxLength="200" /></td>
	            </tr>
            </table>
        </td>
    </tr>
