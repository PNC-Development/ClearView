<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frame_document_browser.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.frame_document_browser" %>
...
<table width="100%" height="100%" border="0" cellSpacing="0" cellPadding="0">
    <tr height="1">
        <td colspan="2">
            <table width="100%" border="0" cellSpacing="2" cellPadding="2" bgcolor="#e6e9f0">
	            <tr bgcolor="#e6e9f0">
		            <td><b><asp:Literal ID="litApplication" runat="server" /> Documents</b></td>
	                <td align="right">
    ...
    <tr>
        <td colspan="2">
            ...
            <table width="100%" height="100%" border="0" cellSpacing="2" cellPadding="2" bgcolor="#c8cfdd">
	            <tr height="1">
	                <td colspan="2">Document:&nbsp;<asp:TextBox ID="txtName" runat="server" CssClass="error" Width="100%" ReadOnly="true" /></td>
                </tr>
	            <tr>
    ...
    <tr height="1">
        <td bgcolor="#c8cfdd">
            <asp:Button ID="btnNone" runat="server" Text="No Document" Width="125" CssClass="default" /> 
        </td>
