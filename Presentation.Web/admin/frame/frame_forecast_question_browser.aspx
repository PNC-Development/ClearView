<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frame_forecast_question_browser.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.frame_forecast_question_browser" %>
    ...
    <tr height="1">
        <td colspan="2">
            <table width="100%" border="0" cellSpacing="2" cellPadding="2" bgcolor="#e6e9f0">
	            <tr bgcolor="#e6e9f0">
		            <td><b>Forecast Question Browser</b></td>
	                <td align="right">
