<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frame_location_c_browser.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.frame_location_c_browser" %>
    ...
    <tr height="1">
        <td colspan="2">
            <table width="100%" border="0" cellSpacing="2" cellPadding="2" bgcolor="#e6e9f0">
	            <tr bgcolor="#e6e9f0">
		            <td><b>Location - City Browser</b></td>
	                <td align="right">
