<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frame_order.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.frame_order" %>
    ...
    function MoveOrderUp(ddl) {
	    if (ddl.selectedIndex > -1) {
		    ...
		    if (oldIndex > -1) {
			    ...
			    alert('You cannot move this page');
	    }
	    else
            ...
            <table width="100%" height="100%" border="0" cellSpacing="2" cellPadding="2" bgcolor="#c8cfdd">
	            <tr>
	                <td valign="top" class="default">
	                    <asp:ListBox ID="lstOrder" runat="server" Width="350" CssClass="default" Rows="22"/>
