<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frame_page_browser.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.frame_page_browser" %>
...
<table width="100%" height="100%" border="0" cellSpacing="0" cellPadding="0">
    ...
    <tr>
        <td colspan="2">
            ...
            <table width="100%" height="100%" border="0" cellSpacing="2" cellPadding="2" bgcolor="#c8cfdd">
	            <tr height="1">
	                <td>Application:</td>
	                <td width="100%"><asp:TextBox ID="txtName" runat="server" CssClass="default" Width="100%" ReadOnly="true" /></td>
                </tr>
	            <tr>
    ...
    <tr height="1">
        <td bgcolor="#c8cfdd">
            <asp:Button ID="btnNone" runat="server" Text="No Parent Page" Width="125" CssClass="default" /> 
        </td>
