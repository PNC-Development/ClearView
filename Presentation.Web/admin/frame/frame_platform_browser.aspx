<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frame_platform_browser.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.frame_platform_browser" %>
    ...
    <tr>
        <td colspan="2">
            ...
            <table width="100%" height="100%" border="0" cellSpacing="2" cellPadding="2" bgcolor="#c8cfdd">
	            <tr height="1">
	                <td colspan="2">Platform:&nbsp;<asp:TextBox ID="txtName" runat="server" CssClass="error" Width="100%" ReadOnly="true" /></td>
                </tr>
	            <tr>
