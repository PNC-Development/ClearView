<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frame_platform_users.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.frame_platform_users" %>
                ...
                <tr height="1"> 
                    ...
                    <td width="100%">
                        <asp:DropDownList ID="ddlLevel" runat="server" CssClass="default" Width="200">
                            <asp:ListItem Value="1" Text="Inventory Manager" />
                            <asp:ListItem Value="0" Text="Routing / Approval" Enabled="false" />
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr height="1">
                            ...
                            <asp:repeater ID="rptItems" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><%# (DataBinder.Eval(Container.DataItem, "inventory").ToString() == "1" ? "Inventory Manager" : "Routing / Approval")%></td>
