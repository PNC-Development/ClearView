<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frame_question_platforms.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.frame_question_platforms" %>
    ...
    <tr height="1">
        <td colspan="2">
            <table width="100%" border="0" cellSpacing="2" cellPadding="2" bgcolor="#e6e9f0">
	            <tr bgcolor="#e6e9f0">
		            <td><b><asp:Label ID="lblName" runat="server" CssClass="default" /> Platforms</b></td>
	                <td align="right">
