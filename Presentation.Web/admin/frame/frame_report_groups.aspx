<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frame_report_groups.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.frame_report_groups" %>
    ...
    <tr>
        <td colspan="2">
            ...
            <table width="100%" height="100%" border="0" cellSpacing="2" cellPadding="2" bgcolor="#c8cfdd">
                <tr> 
                    <td>Application:</td>
                    <td width="100%"><asp:label ID="lblApplication" CssClass="default" runat="server" /></td>
                </tr>
                <tr>
                    <td>Available:</td>
