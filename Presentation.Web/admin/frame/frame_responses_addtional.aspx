<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frame_responses_addtional.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.frame_responses_addtional" %>
...
<table width="100%" height="100%" border="0" cellSpacing="0" cellPadding="0">
    <tr height="1">
        <td colspan="2">
            <table width="100%" border="0" cellSpacing="2" cellPadding="2" bgcolor="#e6e9f0">
	            <tr bgcolor="#e6e9f0">
		            <td><b><asp:Label ID="lblName" runat="server" CssClass="default" /> Additional Configuration</b></td>
	                <td align="right">
    ...
    <tr height="1">
        <td bgcolor="#c8cfdd"><asp:Button ID="btnCheckAll" runat="server" Text="Check All" Width="75" CssClass="default" OnClick="btnCheckAll_Click" /></td>
