<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frame_service_folder_browser.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.frame_service_folder_browser" %>
...
<table width="100%" height="100%" border="0" cellSpacing="0" cellPadding="0">
    ...
    <tr>
        <td colspan="2">
            ...
            <table width="100%" height="100%" border="0" cellSpacing="2" cellPadding="2" bgcolor="#c8cfdd">
	            <tr height="1">
	                <td colspan="2">Service:&nbsp;<asp:TextBox ID="txtName" runat="server" CssClass="error" Width="100%" ReadOnly="true" /></td>
                </tr>
	            <tr>
    ...
    <tr height="1">
        <td bgcolor="#c8cfdd">
            <asp:Button ID="btnNone" runat="server" Text="No Service" Width="125" CssClass="default" /> 
        </td>
