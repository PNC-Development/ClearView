<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frame_solution_codes_location.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.frame_solution_codes_location" %>
    ...
    <tr height="1">
        <td colspan="2">
            <table width="100%" border="0" cellSpacing="2" cellPadding="2" bgcolor="#e6e9f0">
	            <tr bgcolor="#e6e9f0">
		            <td><b>Add Solution Code to All Locations</b></td>
	                <td align="right">
    ...
    <tr>
        <td colspan="2">
            ...
            <table width="100%" height="100%" border="0" cellSpacing="2" cellPadding="2" bgcolor="#c8cfdd">
                <tr>
                    <td>Class:</td>
                    <td width="100%"><asp:DropDownList ID="ddlClass" runat="server" CssClass="default" />
                </tr>
                <tr>
                    <td>Environment:</td>
                    <td width="100%"><asp:DropDownList ID="ddlEnvironment" runat="server" CssClass="default" />
                </tr>
                <tr>
                    <td>Code:</td>
                    <td width="100%"><asp:DropDownList ID="ddlCode" runat="server" CssClass="default" />
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>
