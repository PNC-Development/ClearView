<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frame_sql_table_browser.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.frame_sql_table_browser" %>

<script type="text/javascript">
    function Select(strName, oName) {
        oName = document.getElementById(oName);
        oName.innerText = strName;
    }
    function Reset(strName, oName) {
        oName = document.getElementById(oName);
        oName.innerText = strName;
        return false;
    }
    function Update(oName, strControlText) {
        oName = document.getElementById(oName);
        if (strControlText == "")
            window.top.UpdateWindow(oName.value, strControlText, null, null);
        else
            window.top.UpdateWindow(oName.value, strControlText, oName.value, strControlText);
    ...
    <tr>
        <td colspan="2">
            ...
            <table width="100%" height="100%" border="0" cellSpacing="2" cellPadding="2" bgcolor="#c8cfdd">
	            <tr height="1">
	                <td colspan="2">Table:&nbsp;<asp:TextBox ID="txtName" runat="server" CssClass="error" Width="100%" ReadOnly="true" /></td>
                </tr>
	            <tr>
