<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="holidays.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.holidays" %>
...
<script type="text/javascript">
    ...
    var oDate = null;
    var oEnabled = null;
    function Edit(strId, strName, strDate, strEnabled) {
                                ...
                                <asp:repeater ID="rptView" runat="server">
                                    <HeaderTemplate>
                                        <table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
                                            <tr bgcolor="#CCCCCC">
                                                <td class="bold">&nbsp;</td>
                                                <td width="33%" class="bold"><asp:linkbutton ID="lnkName" Text="Name" CommandArgument="name" CssClass="bold" OnClick="OrderView" runat="server"/></td>
                                                <td width="33%" class="bold"><asp:linkbutton ID="lnkHappens" Text="Date" CommandArgument="happens" CssClass="bold" OnClick="OrderView" runat="server"/></td>
                                    ...
                                    <ItemTemplate>
                                        <tr bgcolor="#EFEFEF" onmouseover="AdminMouseOver(this);" onmouseout="AdminMouseOut(this);" onclick="if(event.srcElement.tagName != 'INPUT')Edit('<%# DataBinder.Eval(Container.DataItem, "holidayid") %>','<%# DataBinder.Eval(Container.DataItem, "name") %>','<%# DateTime.Parse(DataBinder.Eval(Container.DataItem, "happens").ToString()).ToShortDateString() %>','<%# DataBinder.Eval(Container.DataItem, "enabled") %>');" class="default">
                                            <td width="5%" align="left">&nbsp;<asp:ImageButton ID="btnDelete" OnClick="btnDeleteLink_Click" runat="server" ToolTip="Delete" ImageAlign="AbsMiddle" ImageUrl="/admin/images/delete.gif" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "holidayid") %>' /></td>
                                            <td width="33%">&nbsp;<%# DataBinder.Eval(Container.DataItem, "name") %></td>
                                            <td width="33%">&nbsp;<%# DateTime.Parse(DataBinder.Eval(Container.DataItem, "happens").ToString()).ToShortDateString() %></td>
                                            <td width="33%">&nbsp;<%# DataBinder.Eval(Container.DataItem, "modified") %></td>
                                            <td align="center"><asp:ImageButton ID="btnEnable" runat="server" ImageAlign="AbsMiddle" ImageUrl='<%# (DataBinder.Eval(Container.DataItem, "enabled").ToString() == "1") ? "/admin/images/enabled.gif" : "/admin/images/disabled.gif" %>' CommandArgument='<%# DataBinder.Eval(Container.DataItem, "holidayid") %>' OnClick="btnEnable_Click" /></td>
                                        </tr>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        </table>
