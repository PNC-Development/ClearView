<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="items.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.items" %>
...
<script type="text/javascript">
    ...
    var oEnabled = null;
    function Edit(strId, strName,strAmount, strEnabled) {
    ...
    function Load() {
        ...
        oAmount = document.getElementById('<%=txtAmount.ClientID%>');         
		    ...
		    <td colspan="2" align="center">
                                ...
                                <asp:repeater ID="rptView" runat="server">
                                    <HeaderTemplate>
                                        <table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
                                            <tr bgcolor="#CCCCCC">
                                                ...
                                                <td width="25%" class="bold"><asp:linkbutton ID="lnkAmount" Text="Amount" CommandArgument="amount" CssClass="bold" OnClick="OrderView" runat="server"/></td>
                                    ...
                                    <ItemTemplate>
                                        <tr bgcolor="#EFEFEF" onmouseover="AdminMouseOver(this);" onmouseout="AdminMouseOut(this);" onclick="if(event.srcElement.tagName != 'INPUT')Edit('<%# DataBinder.Eval(Container.DataItem, "id") %>','<%# DataBinder.Eval(Container.DataItem, "name") %>','<%# DataBinder.Eval(Container.DataItem, "amount") %>','<%# DataBinder.Eval(Container.DataItem, "enabled") %>');" class="default">
                                            ...
                                            <td width="25%">&nbsp;<%# String.Format("{0:C}",DataBinder.Eval(Container.DataItem, "amount")) %></td>
                ...
                <div id="divAdd" runat="server" style="display:none">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        ...
                        <tr> 
                            <td class="default" width="100px">Amount:</td>
                            <td><asp:textbox ID="txtAmount" CssClass="default" runat="server" Width="300" MaxLength="100"/></td>
                        </tr>                     
                        <tr> 
