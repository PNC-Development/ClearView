<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="operating_system_groups.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.operating_system_groups" %>
...
<table width="98%" cellpadding="0" cellspacing="0" border="0" align="center">
		...
		<tr> 
		    <td><b>Operating System Groups</b></td>
		    ...
		    <td colspan="2" align="center">
                ...
                <asp:Panel id="panAdd" runat="server" Visible="false">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        ...
                        <tr> 
                            <td class="cmdefault">&nbsp;</td>
                            <td><asp:Button ID="btnOS" runat="server" Text="Operating Systems" Width="150" CssClass="default" /></td>
                        </tr>
