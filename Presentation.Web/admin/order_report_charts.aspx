<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_report_charts.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.order_report_charts" %>
...
<script type="text/javascript">
    ...
    var oUrl = null;
    var oEnabled = null;
    function Edit(strId, strName,strUrl,strEnabled) {
    ...
    function Load() {
        ...
        oUrl = document.getElementById('<%=txtChartUpload.ClientID%>');     
		    ...
		    <td colspan="2" align="center">
                                ...
                                <asp:repeater ID="rptView" runat="server">
                                    <HeaderTemplate>
                                        <table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
                                            <tr bgcolor="#CCCCCC">
                                                <td class="bold">&nbsp;</td>
                                                <td width="20%" class="bold"><asp:linkbutton ID="lnkName" Text="Name" CommandArgument="name" CssClass="bold" OnClick="OrderView" runat="server"/></td>
                                                <td width="45%" class="bold"><asp:linkbutton ID="lnkUrl" Text="Url" CommandArgument="url" CssClass="bold" OnClick="OrderView" runat="server"/></td>
                                    ...
                                    <ItemTemplate>
                                        <tr bgcolor="#EFEFEF" onmouseover="AdminMouseOver(this);" onmouseout="AdminMouseOut(this);" onclick="if(event.srcElement.tagName != 'INPUT')Edit('<%# DataBinder.Eval(Container.DataItem, "id") %>','<%# DataBinder.Eval(Container.DataItem, "name") %>','<%# DataBinder.Eval(Container.DataItem, "url") %>','<%# DataBinder.Eval(Container.DataItem, "enabled") %>');" class="default">
                                            ...
                                            <td width="45%">&nbsp;<%# DataBinder.Eval(Container.DataItem, "url") %></td>
                ...
                <div id="divAdd" runat="server" style="display:none">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        ...
                        <tr> 
                            <td class="default" width="100px">Upload Chart:</td>                                                         
                            <td><asp:TextBox ID="txtChartUpload" runat="server" CssClass="default" Width="250" /> <asp:Button ID="btnUpload" runat="server" CssClass="default" Text="..." /></td> 
                        </tr>
                        <tr> 
