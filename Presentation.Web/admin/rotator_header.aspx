<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rotator_header.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.rotator_header" %>
...
<script type="text/javascript">
    ...
    var oHidden = null;
    var oImage = null;
    var oImpressions = null;
    var oEnabled = null;
    function Edit(strId, strImage, strImpressions, strEnabled) {
        ...
        oImpressions.value = strImpressions;
    ...
    function Load() {
        ...
        oImpressions = document.getElementById('<%=txtImpressions.ClientID%>');
...
<table width="98%" cellpadding="0" cellspacing="0" border="0" align="center">
		...
		<tr> 
		    <td><b>Rotator Header Images</b></td>
		    ...
		    <td colspan="2" align="center">
                                ...
                                <asp:repeater ID="rptView" runat="server">
                                    <HeaderTemplate>
                                        <table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
                                            <tr bgcolor="#CCCCCC">
                                                <td class="bold">&nbsp;</td>
                                                <td width="50%" class="bold"><asp:linkbutton ID="lnkName" Text="Name" CommandArgument="imageurl" CssClass="bold" OnClick="OrderView" runat="server"/></td>
                                    ...
                                    <ItemTemplate>
                                        <tr bgcolor="#EFEFEF" onmouseover="AdminMouseOver(this);" onmouseout="AdminMouseOut(this);" onclick="if(event.srcElement.tagName != 'INPUT')Edit('<%# DataBinder.Eval(Container.DataItem, "id") %>','<%# DataBinder.Eval(Container.DataItem, "imageurl") %>','<%# DataBinder.Eval(Container.DataItem, "impressions") %>','<%# DataBinder.Eval(Container.DataItem, "enabled") %>');" class="default">
                                            ...
                                            <td width="50%">&nbsp;<%# DataBinder.Eval(Container.DataItem, "imageurl") %></td>
                ...
                <div id="divAdd" runat="server" style="display:none">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        ...
                        <tr> 
                            <td class="default">Impressions:</td>
                            <td><asp:textbox ID="txtImpressions" CssClass="default" runat="server" Width="50" MaxLength="3"/> [0 - 100]</td>
                        </tr>
                        <tr> 
