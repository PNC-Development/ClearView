<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="segments.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.segments" %>
...
<script type="text/javascript">
    ...
    var oEnabled = null;
    function Edit(strId, strName, strOrganization, strEnabled) {
        ...
        oHidden.value = strId;
        oName.value = strName;
        for (var ii=0; ii<oOrganization.length; ii++) {
            if (oOrganization.options[ii].value == strOrganization)
                oOrganization.selectedIndex = ii;
        }
    ...
    function Load() {
        ...
        oOrganization = document.getElementById('<%=ddlOrganization.ClientID%>');
		    ...
		    <td colspan="2" align="center">
                ...
                <div id="divAdd" runat="server" style="display:none">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        ...
                        <tr> 
                            <td class="default" width="100px">Organization:</td>
                            <td><asp:dropdownlist ID="ddlOrganization" CssClass="default" runat="server" /></td>
                        </tr>
                        <tr> 
