<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="servername_components.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.servername_components" %>
                ...
                <asp:Panel id="panAdd" runat="server" Visible="false">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        ...
                        <tr> 
                            ...
                            <td><asp:textbox ID="txtCode" CssClass="default" runat="server" Width="100" MaxLength="20"/></td>
                        </tr>
                        <tr> 
                        ...
                        <tr> 
                            ...
                            <td><asp:textbox ID="txtFactoryCodeSpecific" CssClass="default" runat="server" Width="100" MaxLength="10"/></td>
                        </tr>
                        <tr> 
                            <td class="default">ZEUS Code:</td>
                            <td><asp:textbox ID="txtZeusCode" CssClass="default" runat="server" Width="200" MaxLength="50"/></td>
                        </tr>
                        <tr> 
                            ...
                            <td>
                                <table cellpadding="2" cellspacing="1" border="0">
                                    <tr>
                                        <td><asp:RadioButton ID="radIIS" runat="server" CssClass="default" Text="IIS" GroupName="type" /></td>
                                        <td><asp:RadioButton ID="radWeb" runat="server" CssClass="default" Text="Web (not IIS)" GroupName="type" /></td>
                                        <td><asp:RadioButton ID="radSQL" runat="server" CssClass="default" Text="SQL Database" GroupName="type" /></td>
                                        <td><asp:RadioButton ID="radDatabase" runat="server" CssClass="default" Text="Database (not SQL)" GroupName="type" /></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        <tr> 
                            <td class="default">Erase Existing SAN:</td>
                            <td><asp:CheckBox ID="chkResetSAN" runat="server" /></td>
                        </tr>
                        <tr> 
