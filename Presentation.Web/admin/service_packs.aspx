<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="service_packs.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.service_packs" %>
...
<script type="text/javascript">
    ...
    var oNumber = null;
    var oEnabled = null;
    function Edit(strId, strName, strNumber, strEnabled) {
    ...
    function Load() {
        ...
        oNumber = document.getElementById('<%=txtNumber.ClientID%>');
...
<table width="98%" cellpadding="0" cellspacing="0" border="0" align="center">
		...
		<tr> 
		    <td><b>Operating Systems - Service Packs / Maintenance Levels</b></td>
		    ...
		    <td colspan="2" align="center">
                ...
                <div id="divAdd" runat="server" style="display:none">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        ...
                        <tr> 
                            <td class="default" width="100px">Number:</td>
                            <td><asp:textbox ID="txtNumber" CssClass="default" runat="server" Width="50" MaxLength="2"/></td>
                        </tr>
                        <tr> 
