<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="service_types.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.service_types" %>
...
<script type="text/javascript">
    ...
    var oOnDemand = null;
    var oEnabled = null;
    function Edit(strId, strName, strPath, strOnDemand, strEnabled) {
        ...
        oName.value = strName;
        oPath.value = strPath;
        oOnDemand.checked = (strOnDemand == "1");
    ...
    function Load() {
        ...
        oOnDemand = document.getElementById('<%=chkOnDemand.ClientID%>');
		    ...
		    <td colspan="2" align="center">
                        ...
                        <tr>
                            <td>
                                <asp:repeater ID="rptView" runat="server">
                                    ...
                                    <ItemTemplate>
                                        <tr bgcolor="#EFEFEF" onmouseover="AdminMouseOver(this);" onmouseout="AdminMouseOut(this);" onclick="if(event.srcElement.tagName != 'INPUT')Edit('<%# DataBinder.Eval(Container.DataItem, "typeid") %>','<%# DataBinder.Eval(Container.DataItem, "name") %>','<%# DataBinder.Eval(Container.DataItem, "path") %>','<%# DataBinder.Eval(Container.DataItem, "ondemand") %>','<%# DataBinder.Eval(Container.DataItem, "enabled") %>');" class="default">
                                            <td width="5%" align="left">&nbsp;<asp:ImageButton ID="btnDelete" OnClick="btnDeleteLink_Click" runat="server" ToolTip="Delete" ImageAlign="AbsMiddle" ImageUrl="/admin/images/delete.gif" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "typeid") %>' /></td>
                                            <td width="50%">&nbsp;<%# DataBinder.Eval(Container.DataItem, "name") %></td>
                                            <td width="50%">&nbsp;<%# DataBinder.Eval(Container.DataItem, "modified") %></td>
                                            <td align="center"><asp:ImageButton ID="btnEnable" runat="server" ImageAlign="AbsMiddle" ImageUrl='<%# (DataBinder.Eval(Container.DataItem, "enabled").ToString() == "1") ? "/admin/images/enabled.gif" : "/admin/images/disabled.gif" %>' CommandArgument='<%# DataBinder.Eval(Container.DataItem, "typeid") %>' OnClick="btnEnable_Click" /></td>
                                        </tr>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        </table>
                ...
                <div id="divAdd" runat="server" style="display:none">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        ...
                        <tr> 
                            <td class="default">On Demand:</td>
                            <td><asp:CheckBox ID="chkOnDemand" runat="server" /></td>
                        </tr>
                        <tr> 
