<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sync_org.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.sync_org" %>
...
<table width="98%" cellpadding="0" cellspacing="0" border="0" align="center">
		...
		<tr> 
		    <td><b>Sync Org Chart</b></td>
		    <td align="right"></td>
		</tr>
		<tr><td colspan="2">&nbsp;</td></tr>
		<tr>
		    <td colspan="2" align="center">
		        <div id="divSync" runat="server" style="display:inline">
		        <table width="100%" cellpadding="2" cellspacing="0" border="0">
		            ...
		            <tr>
		                <td><asp:Button ID="btnAppPages" runat="server" CssClass="default" Width="250" Text="Update Default App Pages" OnClick="btnAppPages_Click" /></td>
		            </tr>
		            <tr>
		                <td><hr size="1" noshade /></td>
		            </tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                ...
	                <tr><td>&nbsp;</td></tr>
	                <tr>
		                <td align="center" class="hugeheader"><p>ClearView is syncing with the Org Chart</p></td>
	                </tr>
	                <tr><td>&nbsp;</td></tr>
	                <tr><td>&nbsp;</td></tr>
	                <tr>
