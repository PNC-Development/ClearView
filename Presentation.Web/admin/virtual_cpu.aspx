<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="virtual_cpu.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.virtual_cpu" %>
                ...
                <div id="divAdd" runat="server" style="display:none">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        ...
                        <tr> 
                            ...
                            <td><asp:textbox ID="txtValue" CssClass="default" runat="server" Width="200" MaxLength="10"/></td>
                        </tr>
                        <tr> 
