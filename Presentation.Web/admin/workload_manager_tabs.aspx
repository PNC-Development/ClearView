<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="workload_manager_tabs.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.workload_manager_tabs" %>
...
<script type="text/javascript">
    ...
    var oPath = null;
    var oTabName = null;
    function Edit(strId, strName, strEnabled,strPath,strTabName) {
    ...
    function Load() {
        ...
        oTabName = document.getElementById('<%=txtTabName.ClientID%>');
    }
</script>
<html>
<head>
...
<table width="98%" cellpadding="0" cellspacing="0" border="0" align="center">
		...
		<tr> 
		    <td><b>Workload Manager Tabs</b></td>
                                ...
                                <asp:repeater ID="rptView" runat="server">
                                    <HeaderTemplate>
                                        <table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
                                            <tr bgcolor="#CCCCCC">
                                                ...
                                                <td width="20%" class="bold"><asp:linkbutton ID="lnkTabName" Text="Tab Name" CommandArgument="tabname" CssClass="bold" OnClick="OrderView" runat="server"/></td>
                                                <td width="30%" class="bold"><asp:linkbutton ID="lnlPath" Text="Path" CommandArgument="path" CssClass="bold" OnClick="OrderView" runat="server"/></td>
                                    ...
                                    <ItemTemplate>
                                        <tr bgcolor="#EFEFEF" onmouseover="AdminMouseOver(this);" onmouseout="AdminMouseOut(this);" onclick="if(event.srcElement.tagName != 'INPUT')Edit('<%# DataBinder.Eval(Container.DataItem, "id") %>','<%# DataBinder.Eval(Container.DataItem, "name") %>','<%# DataBinder.Eval(Container.DataItem, "enabled") %>','<%# DataBinder.Eval(Container.DataItem, "path") %>','<%# DataBinder.Eval(Container.DataItem, "tabname") %>');" class="default">
                                            ...
                                            <td width="20%">&nbsp;<%# DataBinder.Eval(Container.DataItem, "tabname") %></td>
                                            <td width="30%">&nbsp;<%# DataBinder.Eval(Container.DataItem, "path") %></td>
                ...
                <div id="divAdd" runat="server" style="display:none">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        <tr> 
                         ...
                         <tr> 
                            <td class="default" width="100px">Tab Name:</td>
                            <td><asp:textbox ID="txtTabName" CssClass="default" runat="server" Width="300" MaxLength="100"/></td>
                        </tr>
                        <tr> 
                            <td class="default">Path:</td>
                            <td><asp:textbox ID="txtPath" CssClass="default" runat="server" Width="400" MaxLength="100"/> <asp:button ID="btnWMBrowse" runat="server" Text="..." Width="25" CssClass="default"/></td>
                        </tr>
                        <tr> 
