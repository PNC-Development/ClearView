<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zeus_array_configs.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.zeus_array_configs" %>
...
<script type="text/javascript">
    ...
    var oHidden = null;
    var oName = null;
    var oArrayConfig = null;
    var oArrayConfigSan = null;
    var oArrayConfigCluster = null;
    var oEnabled = null;
    function Edit(strId, strName, strArrayConfig, strArrayConfigSan, strArrayConfigCluster, strEnabled) {
        ...
        oHidden.value = strId;
        oName.value = strName;
        oArrayConfig.value = strArrayConfig;
        oArrayConfigSan.value = strArrayConfigSan;
        oArrayConfigCluster.value = strArrayConfigCluster;
    ...
    function Add() {
        ...
        oName.value = "";
        oArrayConfig.value = "";
        oArrayConfigSan.value = "";
        oArrayConfigCluster.value = "";
    ...
    function Load() {
        ...
        oArrayConfig = document.getElementById('<%=txtArrayConfig.ClientID%>');
        oArrayConfigSan = document.getElementById('<%=txtArrayConfigSan.ClientID%>');
        oArrayConfigCluster = document.getElementById('<%=txtArrayConfigCluster.ClientID%>');
		    ...
		    <td colspan="2" align="center">
                ...
                <div id="divAdd" runat="server" style="display:none">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        ...
                        <tr> 
                            <td class="default" width="100px">Array Config:</td>
                            <td><asp:textbox ID="txtArrayConfig" CssClass="default" runat="server" Width="300" MaxLength="100"/></td>
                        </tr>
                        <tr> 
                            <td class="default" width="100px">Array Config SAN:</td>
                            <td><asp:textbox ID="txtArrayConfigSan" CssClass="default" runat="server" Width="300" MaxLength="100"/></td>
                        </tr>
                        <tr> 
                            <td class="default" width="100px">Array Config CLUSTER:</td>
                            <td><asp:textbox ID="txtArrayConfigCluster" CssClass="default" runat="server" Width="300" MaxLength="100"/></td>
                        </tr>
                        <tr> 
