<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zeus_build_types.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.zeus_build_types" %>
...
<script type="text/javascript">
    ...
    var oBuildType = null;
    var oEnabled = null;
    function Edit(strId, strName, strBuildType, strEnabled) {
    ...
    function Load() {
        ...
        oBuildType = document.getElementById('<%=txtBuildType.ClientID%>');
		    ...
		    <td colspan="2" align="center">
                ...
                <div id="divAdd" runat="server" style="display:none">
                    <table width="95%" cellpadding="3" cellspacing="0" border="0" align="center">
                        ...
                        <tr> 
                            <td class="default" width="100px">Build Type:</td>
                            <td><asp:textbox ID="txtBuildType" CssClass="default" runat="server" Width="300" MaxLength="100"/></td>
                        </tr>
                        <tr> 
