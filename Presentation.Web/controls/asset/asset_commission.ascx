<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="asset_commission.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.asset_commission" %>
    ...
    <tr>
        ...
        <td width="100%" bgcolor="#FFFFFF">
            ...
            <table width="100%" cellpadding="0" cellspacing="5" border="0">
                <tr>
                    <td rowspan="2"><img src="/images/asset_commission.gif" border="0" align="absmiddle" /></td>
                    <td class="header" width="100%" valign="bottom">Commission Asset</td>
                </tr>
                <tr>
                    <td width="100%" valign="top">Commissioning an asset means you are moving it from storage into a working environment.</td>
                </tr>
            </table>
            ...
            <table width="100%" cellpadding="4" cellspacing="0" border="0" align="center"  style="border:solid 1px #CCCCCC">
                <tr bgcolor="#EEEEEE">
                    ...
                    <td><asp:LinkButton ID="btnOrderBy" runat="server" CssClass="tableheader" Text="<b>Checked In By</b>" OnClick="btnOrder_Click" CommandArgument="username" /></td>
                    <td><asp:LinkButton ID="btnOrderOn" runat="server" CssClass="tableheader" Text="<b>Checked In On</b>" OnClick="btnOrder_Click" CommandArgument="datestamp" /></td>
                </tr>
            ...
            <table cellpadding="4" cellspacing="3" border="0">
                ...
                <tr>
                    <td colspan="2">
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td nowrap class="bold">Import Commissions</td>
                ...
                <tr>
                    <td></td>
                    <td width="100%"><asp:Button ID="btnImport" runat="server" CssClass="default" Text="Import" Width="75" Enabled="false" /></td>
                </tr>
            </table>
            <p>&nbsp;</p>
        </td>
