<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="costavoidance_all.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.costavoidance_all" %>
            ...
            <asp:repeater ID="rptView" runat="server">
                <HeaderTemplate>
                    <tr bgcolor="#EEEEEE">
                        ...
                        <td><asp:LinkButton ID="btnOrderSubmitter" runat="server" CssClass="tableheader" Text="<b>Submitter</b>" OnClick="btnOrder_Click" CommandArgument="userid"/></td>
                ...
                <ItemTemplate>
                    <tr onmouseover="CellRowOver(this);" onmouseout="CellRowOut(this);" onclick="ViewCostAvoidance('<%# DataBinder.Eval(Container.DataItem, "id").ToString()%>','1');">
                        ...
                        <td valign="top" nowrap><%# oUser.GetFullName(Int32.Parse(DataBinder.Eval(Container.DataItem, "userid").ToString())) %></td>
