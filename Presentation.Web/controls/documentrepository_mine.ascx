<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="documentrepository_mine.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.documentrepository_mine" %>
    ...
    <tr>
        ...
        <td width="100%" bgcolor="#FFFFFF">
            ...
            <asp:Panel ID="panView" runat="server" Visible="true">
                <%=strMenuTab1 %>
                <div id="divMenu1"> 
                <div id="divTab1" style='<%=boolMine == true ? "display:inline" : "display:none" %>'>
                    <br />
                    <table width="100%" cellpadding="0" cellspacing="5" border="0">
                        <tr>
                            <td rowspan="2"><img src="/images/documents.gif" border="0" align="absmiddle" /></td>
                            <td class="header" width="100%" valign="bottom"> My Documents</td>
                        </tr>
                        <tr>
                            <td width="100%" valign="top">Lists all your files / folders.</td>
                        </tr>
                    </table>
                ...
                <div id="divTab2" style='<%=boolOthers == true ? "display:inline" : "display:none" %>'>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="5" border="0">
                        <tr>
                            <td rowspan="2"><img src="/images/documents_mine_shared.gif" border="0" align="absmiddle" /></td>
                            <td class="header" width="100%" valign="bottom"> Shared Documents</td>
                        </tr>
                        <tr>
                            <td width="100%" valign="top">Lists all shared files by other users.</td>
                        </tr>
                    </table>
                    <table width="100%" cellpadding="4" cellspacing="3" border="0">                       
                        <tr>
                                ...
                                <asp:Repeater ID="rptOthers" runat="server">
                                   <ItemTemplate>
                                        <tr>
                                            ...
                                            <td width="100%"><a href="javascript:void(0);" onclick="ShowHideDiv2('div<%# DataBinder.Eval(Container.DataItem, "userid") %>');"><%# DataBinder.Eval(Container.DataItem, "username") %> (<%# DataBinder.Eval(Container.DataItem, "docs") %>)</a></td>
                                        </tr>
                                        <tr id='div<%#DataBinder.Eval(Container.DataItem, "userid").ToString()%>' style="display:none">
                                            <td colspan="2">
                                              <table width="100%" cellpadding="5" cellspacing="0" border="0" class="default" style="border:solid 1px #CCCCCC">                                                
                                   ...
                                   <AlternatingItemTemplate>
                                        ...
                                        <tr bgcolor="#F6F6F6" id='div<%#DataBinder.Eval(Container.DataItem, "userid").ToString()%>' style="display:none">
                                            <td colspan="2">
                                              <table width="100%" cellpadding="5" cellspacing="0" border="0" class="default" style="border:solid 1px #CCCCCC">                                                
                                                <asp:repeater id="rptShared" datasource='<%# ((DataRowView)Container.DataItem).Row.GetChildRows("relationship") %>' runat="server">
                                                   <HeaderTemplate>                          
