<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="fore_everyone.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.fore_everyone" %>
            ...
            <fieldset>
                ...
                <table width="100%" cellpadding="4" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td width="33%"><asp:TextBox ID="txtFilterName" runat="server" CssClass="default" Width="200" /></td>
                        <td nowrap>Project Number:</td>
                        <td width="33%"><asp:TextBox ID="txtFilterNumber" runat="server" CssClass="default" Width="75" /></td>
                        <td nowrap>Portfolio:</td>
                        <td width="33%"><asp:DropDownList ID="ddlFilterPortfolio" runat="server" CssClass="default" /></td>
                        <td nowrap><asp:Button ID="btnFilter" runat="server" CssClass="default" Width="100" Text="Apply Filter" OnClick="btnFilter_Click" /></td>
                    </tr>
                    <tr>
                        <td nowrap>Nickname:</td>
                        <td width="33%"><asp:TextBox ID="txtFilterNickname" runat="server" CssClass="default" Width="200" /></td>
                        <td nowrap>Design ID:</td>
                        <td width="33%"><asp:TextBox ID="txtFilterDesignID" runat="server" CssClass="default" Width="75" /></td>
                        <td nowrap>Requester:</td>
                        <td width="33%"><asp:DropDownList ID="ddlFilterRequester" runat="server" CssClass="default" /></td>
                        <td></td>
                    </tr>
                </table>
            </fieldset>
            ...
            <asp:repeater ID="rptView" runat="server">
                ...
                <ItemTemplate>
                    <tr class="default" onmouseover="CellRowOver(this);" onmouseout="CellRowOut(this);" onclick="ViewItem('<%# strRedirect + "?id=" + DataBinder.Eval(Container.DataItem, "id") %>');">
                        ...
                        <td><%# DataBinder.Eval(Container.DataItem, "manager")%></td>
