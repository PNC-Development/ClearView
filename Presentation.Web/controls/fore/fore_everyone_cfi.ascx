<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="fore_everyone_cfi.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.fore_everyone_cfi" %>
            ...
            <fieldset>
                ...
                <table width="100%" cellpadding="4" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td width="50%"><asp:TextBox ID="txtFilterName" runat="server" CssClass="default" Width="300" /></td>
                        <td nowrap>Project Number:</td>
                        <td width="50%"><asp:TextBox ID="txtFilterNumber" runat="server" CssClass="default" Width="150" /></td>
                    ...
                    <tr>
                        ...
                        <td width="50%"><asp:DropDownList ID="ddlFilterRequester" runat="server" CssClass="default" /></td>
                        <td nowrap>Design ID:</td>
                        <td width="50%"><asp:TextBox ID="txtFilterDesignID" runat="server" CssClass="default" Width="150" /></td>
                        <td></td>
                    </tr>
                </table>
            </fieldset>
