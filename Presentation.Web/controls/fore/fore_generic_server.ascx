<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="fore_generic_server.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.fore_generic_server" %>
...
<table id="tblMain" width="100%" cellpadding="4" cellspacing="2" border="0" >
    <tr>
        <td nowrap><asp:Label ID="lblType" runat="server" CssClass="default" Text="<b>Type:</b><font class='required'>&nbsp;*</font>" />
        </td>
        <td width="100%"><asp:DropDownList ID="ddlTypes" runat="server" CssClass="default" AutoPostBack="true" OnSelectedIndexChanged="ddlTypes_Change" /></td>
    </tr>
    <asp:Panel ID="panModels" runat="server" Visible="false">
    <tr>
        <td nowrap><asp:Label ID="lblModel" runat="server" CssClass="default" Text="<b>Model:</b><font class='required'>&nbsp;*</font>" />
        </td>
