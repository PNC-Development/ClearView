<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="fore_new.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.fore_new" %>
<script type="text/javascript">
    function EditForecast(strID) {
        OpenWindow('FORECAST_EQUIPMENT','?id=' + strID);
        return false;
    }
    ...
    <tr>
        ...
        <td width="100%" bgcolor="#FFFFFF">
            ...
            <table width="100%" cellpadding="0" cellspacing="5" border="0">
                ...
                <tr>
                    <td width="100%" valign="top">The design builder module is used to plan and design project requirements.</td>
                </tr>
            </table>
                    ...
                    <tr>
                        <td width="50%" valign="top">
                            <table width="100%" cellpadding="4" cellspacing="3" border="0">
                                ...
                                <asp:Panel ID="panEditManager" runat="server" Visible="false">
                                <tr>
                                ...
                                <asp:Panel ID="panViewManager" runat="server" Visible="false">
                                <tr>
                                    <td nowrap>Project Manager:</td>
                                    <td width="100%"><asp:Label ID="lblManager" runat="server" CssClass="default" /></td>
                                </tr>
                                </asp:Panel>
                                <asp:Panel ID="panEditEngineer" runat="server" Visible="false">
                                <tr>
                                    <td nowrap>Integration Engineer:<font class="required">&nbsp;*</font></td>
                                    <td width="100%">
                                    <table cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                ...
                                <asp:Panel ID="panViewEngineer" runat="server" Visible="false">
                                <tr>
                                    <td nowrap>Integration Engineer:</td>
                                    <td width="100%"><asp:Label ID="lblEngineer" runat="server" CssClass="default" /></td>
                                </tr>
                                </asp:Panel>
                                <asp:Panel ID="panEditLead" runat="server" Visible="false">
                                <tr>
                                    <td nowrap>Technical Lead:<font class="required">&nbsp;*</font></td>
                                    <td width="100%">
                                    <table cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                ...
                                <asp:Panel ID="panViewLead" runat="server" Visible="false">
                                <tr>
                                    <td nowrap>Technical Lead:</td>
                                    <td width="100%"><asp:Label ID="lblLead" runat="server" CssClass="default" /></td>
                                </tr>
                                </asp:Panel>
                                <asp:Panel ID="panEdit" runat="server" Visible="false">
                                <tr>
                                    <td nowrap class="required">* = Required Field</td>
                                    <td width="100%"><asp:Button ID="btnSubmit" runat="server" CssClass="default" Width="75" Text="Update" OnClick="btnSubmit_Click" /></td>
                                </tr>
                                </asp:Panel>
                            </table>
                        </td>
                        <td width="50%" valign="top" align="center">
                            <table width="200" cellpadding="4" cellspacing="3" border="0">
                                ...
                                <tr>
                                    <td><a href="http://pnc.wss.ntl-city.net/pncncc/pncnccit/itdatacenter/Integration%20Team%20Project%20Documents/Server%20Name%20Standards%20v5.doc" target="_blank"><img src="/images/icons/doc.gif" border="0" align="absmiddle" /><img src="/images/spacer.gif" border="0" width="5" height="1" />View the PNC Server Naming Standards</a></td>
                                </tr>
                                <tr>
                ...
                <table width="100%" cellpadding="4" cellspacing="0" border="0" align="center"  style="border:solid 1px #CCCCCC">
                    <tr bgcolor="#EEEEEE">
                        ...
                        <td valign="bottom" align="center"><b><u>Start&nbsp;Build<br />Date:</u></b></td>
                    ...
                    <asp:repeater ID="rptAll" runat="server">
                        <ItemTemplate>
                            <tr<%# (Request.QueryString["highlight"] != null && Request.QueryString["highlight"] == DataBinder.Eval(Container.DataItem, "id").ToString() ? " bgcolor=\"#99FF99\"" : "")%>>
                                ...
                                <asp:Label ID="lblHA" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container.DataItem, "ha") %>' />
                                ...
                                <!--
                                <td valign="top" align="center" nowrap><asp:LinkButton ID="lnkProduction" runat="server" Text='<%# (DataBinder.Eval(Container.DataItem, "production").ToString() == "" ? "---" : DateTime.Parse(DataBinder.Eval(Container.DataItem, "production").ToString()).ToShortDateString()) %>' /></td>                                 
                                -->
                                <td valign="top" align="center" nowrap>
                                    ...
                                    <asp:Panel ID="panComplete" runat="server" Visible="false">
                                        <table cellpadding="0" cellspacing="0" border="0" class="design_built">
                                            ...
                                            <tr>
                                                <td><img src="/images/check_small.gif" border="0" align="absmiddle" />&nbsp;<asp:Label ID="lblComplete" runat="server" CssClass="default" Text='<%# DataBinder.Eval(Container.DataItem, "completed") %>' /></td>
                                            </tr>
                                        </table>
                                    </asp:Panel>
                                    <asp:Panel ID="panAbandoned" runat="server" Visible="false">
                                        <table cellpadding="0" cellspacing="0" border="0" class="design_built">
                                            ...
                                            <tr>
                                                <td><img src="/images/alert_small.gif" border="0" align="absmiddle" />&nbsp;<asp:Label ID="lblAbandoned" runat="server" CssClass="default" Text='<%# DataBinder.Eval(Container.DataItem, "executed") %>' /></td>
                                            </tr>
                                        </table>
                                    </asp:Panel>
                                    <asp:Panel ID="panScheduled" runat="server" Visible="false">
                                        <table cellpadding="0" cellspacing="0" border="0" class="design_scheduled">
                                            ...
                                            <tr>
                                                <td><img src="/images/clock_small.gif" border="0" align="absmiddle" />&nbsp;<asp:Label ID="lblScheduled" runat="server" CssClass="default" Text='<%# DataBinder.Eval(Container.DataItem, "execution") %>' /></td>
                                            </tr>
                                        </table>
                                    </asp:Panel>
                                </td>
                                <td valign="top" align="right" width="1">[<asp:LinkButton ID="btnEdit" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "id") %>' Text="Edit" />]&nbsp;&nbsp;[<asp:LinkButton ID="btnDelete" runat="server" OnClick="btnDelete_Click" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "id") %>' Text="Delete" />]&nbsp;&nbsp;[<asp:LinkButton ID="btnExecute" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "id") %>' Text="Execute" />]</td>
                            </tr>
                        </ItemTemplate>
