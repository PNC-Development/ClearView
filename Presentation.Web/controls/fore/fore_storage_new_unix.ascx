<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="fore_storage_new_unix.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.fore_storage_new_unix" %>
            ...
            <%=strMenuTab1 %>
                                ...
                                <table cellpadding="2" cellspacing="3" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td><div id="divHighOSReplicated" runat="server" style="display:none">
                                            ...
                                            <asp:Label ID="lblOSVolHighPerfReplicatedAmt" runat="server" CssClass="default" Text="Please enter the amount of storage to be replicated:" />
                            ...
                            <td>
                                ...
                                <table cellpadding="2" cellspacing="3" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td><div id="divStandardOSReplicated" runat="server" style="display:none">
                                        <img src="/images/green_right.gif" border="0" align="absmiddle" />
                                        <img src="/images/spacer.gif" border="0" width="10" height="1" />
                                        <asp:Label ID="lblOSVolStandardPerfReplicationAmt" runat="server" CssClass="default" Text="Please enter the amount of storage to be replicated:" />
                                        <img src="/images/spacer.gif" border="0" width="5" height="1" />
                                        <asp:TextBox ID="txtStandardOSReplicated" runat="server" CssClass="default" Width="75" MaxLength="5" /> GB</div></td>
                                    </tr>
                                </table>
                                <br />
                                </asp:Panel>
                                ...
                                <table cellpadding="2" cellspacing="3" border="0">
                                    <tr>
                                        <td align="right"><img src="/images/arrow_down_right.gif" border="0" align="absmiddle" /></td>
                                        <td>
                                        <asp:Label ID="lblOSLevelStandardPerfQAStorageAmt" runat="server" CssClass="default" Text="<b>Standard Performance QA Storage</b> - Please enter the total amount of storage you require in <b>QA</b>:<font class='required'>&nbsp;*</font>" /></td>
                                    </tr>
                                    <tr>
                                        <td><img src="/images/spacer.gif" border="0" width="20" height="1" /></td>
                                        <td>
                            ...
                            <td>
                                ...
                                <table cellpadding="2" cellspacing="3" border="0">
                                    <tr>
                                        <td align="right"><img src="/images/arrow_down_right.gif" border="0" align="absmiddle" /></td>
                                        <td>
                                        <asp:Label ID="lblOSVolLowPerfQAStorage" runat="server" CssClass="default" Text="<b>Low Performance QA Storage</b> - Please enter the total amount of storage you require in <b>QA</b>:<font class='required'>&nbsp;*</font>" /></td>
                                    </tr>
                                    <tr>
                                        <td><img src="/images/spacer.gif" border="0" width="20" height="1" /></td>
                                        <td>
                ...
                <div style="display:none">
                    <table width="100%" cellpadding="1" cellspacing="1" border="0" class="default">
                        <tr>
                            <td>
                            <asp:Label ID="lblChkAppVolIfRequireAnyStorage" runat="server" CssClass="default" Text="Check if you require any of the following storage:<font class='required'>&nbsp;*</font>" /></td>
                            <td align="right"></td>
                        </tr>
                    </table>
                    <table cellpadding="1" cellspacing="1" border="0" class="default">
                            ...
                            <td>
                                ...
                                <table cellpadding="2" cellspacing="3" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <img src="/images/green_right.gif" border="0" align="absmiddle" />
                                        <img src="/images/spacer.gif" border="0" width="10" height="1" />
                                        <asp:Label ID="lblAppVolHighPerfReplicatedAmt" runat="server" CssClass="default" Text="Please enter the amount of storage to be replicated:" />
                                        <img src="/images/spacer.gif" border="0" width="5" height="1" />
                            ...
                            <td>
                                ...
                                <table cellpadding="2" cellspacing="3" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <img src="/images/spacer.gif" border="0" width="5" height="1" /><asp:TextBox ID="txtStandardReplicated" runat="server" CssClass="default" Width="75" MaxLength="5" /> GB</div></td>
                                    </tr>
                                </table>
                                <br />
                                </asp:Panel>
