<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IM_Storage_demand.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.IM_Storage_demand" %>
        ...
        <td id="tdSideBar" valign="top" nowrap style="background-color:#F6F6F6">
            <table width="100%" cellpadding="3" cellspacing="2" border="0">
                ...
                <tr>
                    <td nowrap><img src="/images/arrow_black_right.gif" border="0" /></td>
                    <td colspan="2" nowrap>
                        <asp:CheckBox ID="chkIncludeServerGrowthReqs" Text ="Include Server Growth Requests" runat="server" CssClass="smalldefault"/>
                    </td>
                </tr>
