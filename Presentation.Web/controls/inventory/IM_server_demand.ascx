<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IM_server_demand.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.IM_Server_demand" %>
        ...
        <HeaderTemplate>
           ...
           <ItemTemplate>  
                <tr id="Tr1" class="default" valign="top" align="left" runat="server" >
                    ...
                    <td width="20%"><asp:Label ID="lblDemand" runat="server"/> </td>
                    <td width="5%"><b><asp:Label ID="lblDemandNo" runat="server"/></b></td>
                </tr>
            </ItemTemplate>  
