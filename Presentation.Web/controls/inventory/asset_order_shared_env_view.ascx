<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="asset_order_shared_env_view.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.asset_order_shared_env_view" %>
            ...
            <HeaderTemplate>
                <tr bgcolor="#EEEEEE">
                    ...
                    <td align="left" width="10%">
                        <asp:LinkButton ID="lnkbtnHeaderOrderType" runat="server" CssClass="tableheader" Text="<b>Shared Environment Type</b>"/>
                    </td>
                    <td align="left" width="10%">
