<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="backup_action_avamar.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.backup_action_avamar" %>
...
<table width="100%" height="100%" cellpadding="5" cellspacing="5" border="0">
    <tr height="1">
        <td colspan="2" class="biggerbold">Avamar Test:</td>
    </tr>
    <tr>
        <td>ClassID:</td>
        <td></td>
