<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="backup_supply.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.backup_supply" %>
...
<table width="100%" height="100%" cellpadding="5" cellspacing="5" border="0">
    ...
    <tr>
        <td colspan="2"><asp:PlaceHolder ID="phBackup" runat="server" /></td>
    </tr>
</table>
