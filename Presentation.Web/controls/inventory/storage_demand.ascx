<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="storage_demand.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.storage_demand" %>
    ...
    <tr>
        <td id="tdSideBar" valign="top" nowrap style="background-color:#F6F6F6">
            <table width="100%" cellpadding="3" cellspacing="2" border="0">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td colspan="2" align="right">Order By: <asp:LinkButton ID="btnProjectOrderName" runat="server" Text="Name" OnClick="btnProjectOrderName_Click" /> | <asp:LinkButton ID="btnProjectOrderNumber" runat="server" Text="Number" OnClick="btnProjectOrderNumber_Click" /></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
        ...
        <td valign="top" width="100%" height="100%">
            <asp:Panel ID="panGrowth" runat="server" Visible="false">
                <table width="100%" cellpadding="0" cellspacing="5" border="0" style="border:solid 1px #999999" bgcolor="#f9f9f9">
                    <tr>
                        ...
                        <td class="header" width="100%" valign="bottom">Storage Growth Requests Included</td>
                    </tr>
                    <tr>
                        <td width="100%" valign="top">The pending storage growth requests are included in this view. Once a filter or grouping is applied, the storage growth request data will be excluded. <b>Why?</b> Storage growth requests (enclosure staging, vmware host allocations, etc...) are infrastructure tasks and cannot be related to projects and / or confidence levels.</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td width="100%">To view details regarding the storage requests, click on the correlating hyperlink...</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td width="100%"><img src="/images/storage.jpg" border="0" align="absmiddle" /></td>
                    </tr>
                </table>
                <br />
            </asp:Panel>
