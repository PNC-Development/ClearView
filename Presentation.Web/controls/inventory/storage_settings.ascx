<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="storage_settings.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.storage_settings" %>
...
<table width="100%" cellpadding="4" cellspacing="0" border="0">
    ...
    <tr>
        <td nowrap>Maximum Storage:</td>
        <td width="100%"><asp:TextBox ID="txtMax1" runat="server" CssClass="default" Width="100" MaxLength="10" /> GB</td>
    </tr>
    <tr>
        <td nowrap>Maximum Ports:</td>
        <td width="100%"><asp:TextBox ID="txtMax2" runat="server" CssClass="default" Width="100" MaxLength="10" /> GB</td>
    </tr>
    <tr>
        <td></td>
