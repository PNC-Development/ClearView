<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="sve.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.sve" %>
...
<asp:Panel ID="panClusters" runat="server" Visible="false">
    ...
    <table width="100%" cellpadding="4" cellspacing="0" border="0" align="center" style="border:solid 1px #CCCCCC">
        ...
        <asp:repeater ID="rptClusters" runat="server">
            <ItemTemplate>
                <tr class='<%# DataBinder.Eval(Container.DataItem, "available").ToString() == "1" ? "default" : "component_unavailable" %>' title='<%# DataBinder.Eval(Container.DataItem, "comments").ToString().Replace("'", "\\'") %>' onmouseover="CellRowOver(this);" onmouseout="CellRowOut(this);" onclick="window.navigate('<%# FormURL("cluster=" + DataBinder.Eval(Container.DataItem, "id")) %>');">
    ...
    <div id="divMenu1" class="tabbing">
        ...
        <div style="display:none">
            ...
            <asp:repeater ID="rptHosts" runat="server">
                <ItemTemplate>
                    <tr onmouseover="CellRowOver(this);" onmouseout="CellRowOut(this);" onclick="window.navigate('<%# FormURL("cluster=" + intCluster.ToString() + "&host=" + DataBinder.Eval(Container.DataItem, "id")) %>');">
        ...
        <div style="display:none">
            ...
            <asp:repeater ID="rptProcessors" runat="server">
                <ItemTemplate>
                    <tr class='<%# DataBinder.Eval(Container.DataItem, "enabled").ToString() == "1" ? "default" : "component_unavailable" %>' onmouseover="CellRowOver(this);" onmouseout="CellRowOut(this);" onclick="window.navigate('<%# FormURL("cluster=" + intCluster.ToString() + "&processor=" + DataBinder.Eval(Container.DataItem, "id")) %>');">
        ...
        <div style="display:none">
            ...
            <asp:repeater ID="rptMnemonics" runat="server">
                <ItemTemplate>
                    <tr onmouseover="CellRowOver(this);" onmouseout="CellRowOut(this);" onclick="window.navigate('<%# FormURL("cluster=" + intCluster.ToString() + "&mnemonic=" + DataBinder.Eval(Container.DataItem, "id")) %>');">
        ...
        <div style="display:none">
            ...
            <asp:repeater ID="rptGuests" runat="server">
                <ItemTemplate>
                    <tr onmouseover="CellRowOver(this);" onmouseout="CellRowOut(this);" onclick="if(event.srcElement.tagName != 'INPUT')window.navigate('<%# FormURL("cluster=" + intCluster.ToString() + "&guest=" + DataBinder.Eval(Container.DataItem, "serverid")) %>');">
                        <td><%=intGuestCount++%>.)</td>
                ...
                <AlternatingItemTemplate>
                    <tr style="background-color:#F6F6F6" onmouseover="CellRowOver(this);" onmouseout="CellRowOut(this);" onclick="if(event.srcElement.tagName != 'INPUT')window.navigate('<%# FormURL("cluster=" + intCluster.ToString() + "&guest=" + DataBinder.Eval(Container.DataItem, "serverid")) %>');">
                        <td><%=intGuestCount++%>.)</td>
                        <td><input type="checkbox" onclick="ChangeCheckItems('<%=hdnMove.ClientID %>', '<%# DataBinder.Eval(Container.DataItem, "serverid")%>', this)" /></td>
                        <td width="25%" nowrap><%# DataBinder.Eval(Container.DataItem, "servername")%></td>
                        <td width="20%" nowrap><%# DataBinder.Eval(Container.DataItem, "pool")%></td>
