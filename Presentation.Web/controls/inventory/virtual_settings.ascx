<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="virtual_settings.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.virtual_settings" %>
...
<table width="100%" cellpadding="4" cellspacing="0" border="0">
    ...
    <tr>
        <td nowrap>Maximum RAM:</td>
        <td width="100%"><asp:TextBox ID="txtMax2" runat="server" CssClass="default" Width="100" MaxLength="10" /></td>
    </tr>
    <tr>
        <td nowrap>Maximum Disk Space:</td>
        <td width="100%"><asp:TextBox ID="txtMax3" runat="server" CssClass="default" Width="100" MaxLength="10" /></td>
    </tr>
    <tr>
        <td></td>
