<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="workstations_vmware.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.workstations_vmware" %>

<script type="text/javascript">
    function OpenOnDemandDevice(intAnswer, intNum) {
        return OpenWindow('ONDEMAND_VMWAREWORKSTATION','?aid=' + intAnswer + '&num=' + intNum);
    }
</script>
        ...
        <td valign="top">
            ...
            <table width="100%" cellpadding="3" cellspacing="0" border="0" style="border:solid 1px #CCCCCC">
                <tr bgcolor="#EEEEEE">
                    ...
                    <td width="33%"><b><u>Number:</u></b></td>
                    <td nowrap align="center"><b><u>Device Config:</u></b></td>
                    <td nowrap>&nbsp;</td>
                    <td nowrap align="center"><b><u>Accounts:</u></b></td>
                </tr>
                <%=strDevices %>
            </table>
            </div>
