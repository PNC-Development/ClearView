<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rr_account_copy.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.rr_account_copy" %>

<script type="text/javascript">
</script>
<table width="100%" border="0" cellSpacing="2" cellPadding="4" class="default">
    <tr>
        <td nowrap>User ID <b>from</b> which to copy:<font class="required">&nbsp;*</font></td>
    ...
    <tr>
        <td nowrap>User ID <b>to</b> which to copy:<font class="required">&nbsp;*</font></td>
    ...
    <tr>
        <td colspan="2">Please select the group(s) you want to add to this account:</td>
    </tr>
    <tr>
        <td colspan="2"><asp:CheckBoxList ID="chkGroups" runat="server" CssClass="default" RepeatDirection="Vertical" RepeatColumns="2" CellPadding="3" CellSpacing="2" /></td>
    </tr>
    </asp:Panel>
    <tr>
