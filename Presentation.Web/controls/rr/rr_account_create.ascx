<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rr_account_create.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.rr_account_create" %>
...
<table width="100%" border="0" cellSpacing="2" cellPadding="4" class="default">
    ...
    <tr>
        <td nowrap>User's XID:<font class="required">&nbsp;*</font></td>
    ...
    <tr>
        <td nowrap></td>
        <td width="100%"><asp:Button ID="btnContinue" runat="server" CssClass="default" Text="Continue  >>" Width="150" OnClick="btnContinue_Click" /></td>
    </tr>
            ...
            <div style="display:none">
                ...
                <table width="100%" cellpadding="4" cellspacing="3" border="0">
                    <tr>
                        ...
                        <td width="100%"><asp:Label ID="lblID" runat="server" CssClass="default" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td nowrap>Password:<font class="required">&nbsp;*</font></td>
                        <td width="100%"><asp:TextBox ID="txtPassword1" runat="server" CssClass="default" Width="200" MaxLength="100" TextMode="Password" /></td>
                    </tr>
                    <tr>
                        <td nowrap>Password Again:<font class="required">&nbsp;*</font></td>
                        <td width="100%"><asp:TextBox ID="txtPassword2" runat="server" CssClass="default" Width="200" MaxLength="100" TextMode="Password" /></td>
                    </tr>
                    <tr>
                        <td nowrap>&nbsp;</td>
                        <td width="100%"><asp:CheckBox ID="chkEmail" runat="server" CssClass="default" Text="Enable email for this account" /></td>
                    </tr>
                    <tr>
                        <td nowrap>&nbsp;</td>
                        <td width="100%"><asp:CheckBox ID="chkTechnical" runat="server" CssClass="default" Text="Require access to the registry" /></td>
                    </tr>
                </table>
            </div>
            <div style="display:none">
