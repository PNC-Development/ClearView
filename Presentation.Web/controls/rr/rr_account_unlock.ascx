<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rr_account_unlock.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.rr_account_unlock" %>

<table width="100%" border="0" cellSpacing="2" cellPadding="4" class="default">
    <tr>
        <td nowrap>User ID:<font class="required">&nbsp;*</font></td>
        <td width="100%"><asp:TextBox ID="txtUser" runat="server" CssClass="default" width="125" MaxLength="20" /></td>
    </tr>
    <tr>
