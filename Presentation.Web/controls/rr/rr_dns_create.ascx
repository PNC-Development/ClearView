<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rr_dns_create.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.rr_dns_create" %>
...
<table width="100%" border="0" cellSpacing="4" cellPadding="5" class="default">
    ...
    <tr>
        <td colspan="2">Please enter a device name, IP address and alias and click <b>Next  >></b> to continue...</td>
    </tr>
    <tr id="trQIP" runat="server" visible="false">
        <td nowrap>Object Type:</td>
        <td width="100%"><asp:DropDownList ID="ddlType" runat="server" CssClass="default" /> </td>
    </tr>
    <tr>
        <td nowrap>Device Name:</td>
        <td width="100%"><asp:TextBox ID="txtName" runat="server" CssClass="default" width="200" MaxLength="50" /> <%=strDomain %></td>
    </tr>
    <tr>
        <td nowrap>IP Address:</td>
        <td width="100%">
            <asp:TextBox ID="txtIP1" runat="server" CssClass="default" Width="30" MaxLength="3" />
            &nbsp;.&nbsp;
            <asp:TextBox ID="txtIP2" runat="server" CssClass="default" Width="30" MaxLength="3" />
            &nbsp;.&nbsp;
            <asp:TextBox ID="txtIP3" runat="server" CssClass="default" Width="30" MaxLength="3" />
            &nbsp;.&nbsp;
            <asp:TextBox ID="txtIP4" runat="server" CssClass="default" Width="30" MaxLength="3" />
        </td>
    </tr>
    <tr>
        <td nowrap></td>
            ...
            <asp:Panel ID="panExist" runat="server" Visible="false">
                <table cellpadding="0" cellspacing="5" border="0" style="border:solid 1px #999999" bgcolor="#f9f9f9">
                    <tr>
                        ...
                        <td class="header" valign="bottom">Device Found</td>
                    </tr>
                    <tr>
    ...
    <tr>
        ...
        <td width="100%">
            <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td><asp:TextBox ID="txtAlias" runat="server" CssClass="default" Width="200" MaxLength="200" /></td>
                    <td>&nbsp;</td>
                    <td><%=strDomain %></td>
                    <td>&nbsp;</td>
                    <td><asp:Button ID="btnAdd" runat="server" CssClass="default" Width="75" Text="Add" /><br /></td>
                </tr>
                <tr>
                    <td colspan="2"></td>
    ...
    <tr>
        ...
        <td width="100%">
            <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td><asp:ListBox ID="lstAlias" runat="server" CssClass="default" Width="300" Rows="5" /></td>
                    <td>&nbsp;</td>
                    <td>
                        <asp:Button ID="btnEdit" runat="server" CssClass="default" Width="75" Text="Edit" /><br /><br />
                        <asp:Button ID="btnRemove" runat="server" CssClass="default" Width="75" Text="Remove" />
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td nowrap>Contact # 1:<font class="required">&nbsp;*</font></td>
        <td width="100%">
            <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td><asp:TextBox ID="txtContact1" runat="server" Width="300" CssClass="default" Enabled="false" /></td>
                </tr>
                <tr>
                    <td>
    ...
    <tr>
        <td nowrap>Contact # 2:<font class="required">&nbsp;*</font></td>
        <td width="100%">
            <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td><asp:TextBox ID="txtContact2" runat="server" Width="300" CssClass="default" Enabled="false" /></td>
                </tr>
                <tr>
                    <td>
