<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rr_virtual_workstation_offshore.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.rr_virtual_workstation_offshore" %>
