<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="server_output.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.server_output" %>
        ...
        <td width="100%" bgcolor="#FFFFFF">
            ...
            <table width="100%" cellpadding="0" cellspacing="5" border="0">
                <tr>
                    ...
                    <td class="header" width="100%" valign="bottom">Server Output File Lookup</td>
                </tr>
                <tr>
                    <td width="100%" valign="top">Use this search page to find information regarding a server's scripted output files.</td>
                </tr>
            </table>
            <table width="100%" cellpadding="4" cellspacing="3" border="0">
                ...
                <tr>
                    <td nowrap>Show Log Entries:</td>
                    <td width="100%"><asp:CheckBox ID="chkLog" runat="server" CssClass="default" /></td>
                </tr>
                <tr>
            ...
            <table width="100%" cellpadding="4" cellspacing="3" border="0">
                <tr>
                    <td class="hugeheader"><asp:Label ID="lblServer" runat="server" CssClass="hugeheader" /> Details...</td>
                </tr>
                <%=strResults %>
                <tr>
                    <td><%=strLog %></td>
