<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wm_blade.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.wm_blade" %>
		                                    ...
		                                    <div id="divExecution" style='<%=boolExecution == true ? "display:inline" : "display:none" %>'>
                                                ...
                                                <table width="100%" cellpadding="4" cellspacing="3" border="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="100%">Allocate Storage (if applicable) <span class="reddefault"> - <b>NOTE:</b> Be sure to contact the storage team to make sure they are done.</span></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td nowrap></td>
                                                        <td nowrap></td>
                                                        <td width="100%"><asp:Label ID="lbl7" runat="server" CssClass="default" /></td>
                                                    </tr>
                                                    <tr>
