<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wm_vmware.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.wm_vmware" %>
		                                    ...
		                                    <div id="divExecution" style='<%=boolExecution == true ? "display:inline" : "display:none" %>'>
                                                ...
                                                <table width="100%" cellpadding="4" cellspacing="3" border="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="100%">Reserve Space on Ecom VMWare Host (if applicable)</td>
                                                    </tr>
                                                    <tr>
                                                        <td nowrap></td>
                                                        <td nowrap></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="100%">Move the guest to Ecom Cluster (if applicable)</td>
                                                    </tr>
                                                    <tr>
                                                        <td nowrap></td>
                                                        <td nowrap></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="100%">Configure Additional Storage (if applicable)</td>
                                                    </tr>
                                                    <tr>
                                                        <td nowrap></td>
                                                        <td nowrap></td>
                                                        <td width="100%"><asp:Label ID="lbl8" runat="server" CssClass="default" /></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td width="100%">Find Production Location</td>
                                                    </tr>
                                                    <tr>
                                                        <td nowrap></td>
                                                        <td nowrap></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="100%">Migrate Guests to Production</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td width="100%">Cleanup Test Guests</td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3">&nbsp;</td>
                                                    </tr>
