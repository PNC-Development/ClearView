                    ...
                    <table width="95%" cellpadding="0" cellspacing="5" border="0" style="border:solid 1px #999999" bgcolor="#f9f9f9">
                        ...
                        <tr>
                            <td valign="bottom">
                                ...
                                <p class="bold"><img src="/images/tack.gif" border="0" align="absmiddle" /> After making the necessary changes, click the &quot;Complete&quot; button at the top of this page</p>
                            </td>
                        </tr>
                    </table>
                    <br />
            ...
            <td>
                    <table width="100%" height="100%" border="0" cellSpacing="0" cellPadding="0" class="default">
                        <tr>
                            ...
                            <td class="cmbutton" style='<%=boolExecution == true ? "display:inline;border-bottom:1px solid #FFFFFF;border-top:3px solid orange;" : "" %>' onclick="ChangeFrame(this,'divExecution','divDetails','divStatusUpdates','divChange','divDocuments','<%=hdnTab.ClientID %>','E');" id="tabExecution">Execution</td>
                            <td class="cmbuttonspace">&nbsp;</td>
		                                        ...
		                                        <table width="100%" cellpadding="4" cellspacing="3" border="0">
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                <tr>
                                                                    <td><asp:Button ID="btnStatus" runat="server" CssClass="default" Width="150" Text="Submit Status" OnClick="btnStatus_Click" /></td>
                                                                    <td align="right"><b>NOTE:</b> Your comments will be made public to the client and may be sent via email.</td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
