<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wm_account_maintenance.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.wm_account_maintenance" %>
                    ...
                    <tr>
                        <td valign="top">
                            <table border="0" cellpadding="3" cellspacing="2">
                                ...
                                <tr>
                                    <td><b>User ID:</b></td>
                                    <td><asp:TextBox ID="txtID" runat="server" CssClass="default" Width="100" MaxLength="10" /></td>
                                </tr>
                                </asp:Panel>
                                <asp:Panel ID="panFirst" runat="server" Visible="false">
                                <tr>
                                    <td><b>First Name:</b></td>
                                    <td><asp:TextBox ID="txtFirst" runat="server" CssClass="default" Width="200" MaxLength="100" /></td>
                                </tr>
                                </asp:Panel>
                                <asp:Panel ID="panLast" runat="server" Visible="false">
                                <tr>
                                    <td><b>Last Name:</b></td>
                                    <td><asp:TextBox ID="txtLast" runat="server" CssClass="default" Width="200" MaxLength="100" /></td>
                                </tr>
                                </asp:Panel>
                                <asp:Panel ID="panGroups" runat="server" Visible="false">
                                    <td><b>Groups:</b></td>
                                    <td><asp:CheckBoxList ID="chkGroups" runat="server" CssClass="default" RepeatDirection="Vertical" RepeatColumns="2" CellPadding="3" CellSpacing="2" /></td>
                                </asp:Panel>
                                <asp:Panel ID="panPassword" runat="server" Visible="false">
                                <tr>
                                    <td><b>Default Password:</b></td>
                                    <td><asp:TextBox ID="txtPassword" runat="server" CssClass="default" Width="200" MaxLength="20" TextMode="Password" /></td>
                                </tr>
                                </asp:Panel>
                                <tr>
