<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wm_asset_burnin_deployment.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.wm_asset_burnin_deployment" %>
                                                                             ...
                                                                             <asp:DataList ID="dlAssetList" runat="server" CellPadding="3" CellSpacing="1" Width="100%" OnItemDataBound="dlAssetList_ItemDataBound">
                                                                                <HeaderTemplate>
                                                                                    <tr bgcolor="#EEEEEE" valign="top">
                                                                                        ...
                                                                                        <td align="left" width="100%">
                                                                                            <asp:Label ID="lblAssetListHeaderComments" runat="server" CssClass="default" width="98%" Text="<b>Required Burn-In And Deployment Attributes</b>" />
                                                                                        </td>
                                                                                        <td align="left" nowrap >
                                                                                ...
                                                                                <ItemTemplate>
                                                                                    <tr valign="top">
                                                                                        ...
                                                                                        <td align="left" nowrap>
                                                                                             <asp:LinkButton ID="lnkbtnAssetListEdit" runat="server" ToolTip="Burn-In and Deploy"  Text="Configure" CssClass="lookup" />
                                                                                        </td>
                                                                                    </tr>
                                                                                </ItemTemplate>
                                                                                <AlternatingItemTemplate>
                                                                                    <tr bgcolor="#F6F6F6" valign="top">
                                                                                        ...
                                                                                        <td align="left" >
                                                                                            <asp:HiddenField ID="hdnAssetId" runat="server" />
                                                                                            <asp:HiddenField ID="hdnScanDateTime" runat="server" />
                                                                                            <asp:LinkButton ID="lnkbtnAssetListSerialNo" runat="server" ToolTip="Stage and Configure Asset"  CssClass="lookup" />
