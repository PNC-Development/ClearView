<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wm_asset_checkin.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.wm_asset_checkin" %>
...
<script type="text/javascript">
    ...
    function CheckUnCheckAll(chkAssetListHeaderSelectAll)
    {
       
        var pnlAssetList = document.getElementById("<%=pnlAssetList.ClientID%>");
        var chkState = chkAssetListHeaderSelectAll.checked;  
    ...
    {
        var hdnProcureQuantity = document.getElementById("<%=hdnProcureQuantity.ClientID%>");
        var pnlAssetList = document.getElementById("<%=pnlAssetList.ClientID%>");
        var intSelectedCount=0;
        var inputElements = pnlAssetList.getElementsByTagName("input");
        for(i=0;i<inputElements.length;i++)
        {  
            if(inputElements[i].type=='checkbox' && inputElements[i].name.indexOf('chkSelectAsset') != -1 && inputElements[i].checked==1)
            {   
                intSelectedCount=intSelectedCount+1;
            }
            
        }
       if (hdnProcureQuantity.value <intSelectedCount)
        {
            alert ('Selected asset(s) count is more than requested Order quantity.\n\n Total asset(s) requested for Order is ' + hdnProcureQuantity.value +' . \n\n In order to complete the workflow,  please select  '+ hdnProcureQuantity.value+ ' asset(s) to check in.'); 
            return false;
        }
        else if (hdnProcureQuantity.value >intSelectedCount)
        {
            alert ('Selected asset(s) count is less than requested Order quantity.\n\n Total asset(s) requested for Order is ' + hdnProcureQuantity.value + '. \n\n In order to complete the workflow,  please select  '+ hdnProcureQuantity.value +'  asset(s) to check in.'); 
            return true;
        }
        return true;
    }
		                                        ...
		                                        <br />
                                                    ...
                                                    <br />
		                                             <asp:Panel ID="pnlExecution" runat="server" Visible="true">
		                                               <table width="100%" cellpadding="4" cellspacing="3" border="0">
                                                            <tr id="trLocation" runat="server" valign="top">
                                                                <td nowrap>
                                                                <asp:Label ID="lblLocation" runat="server" CssClass="default" Text="Location Received:<font class='required'>&nbsp;*</font>" />
                                                                </td><td width="100%">
                                                                    <asp:DropDownList ID="ddlDepot" runat="server" CssClass="default" Width="300" />
                                                                    
                                                                </td>
                                                            </tr>
                                                            <tr valign="top">
                                                                <td ><asp:Label ID="lblDateReceived" runat="server" CssClass="default"  Text="Date Received:<font class='required'>&nbsp;*</font>" /></td>
                                                                <td ><asp:TextBox ID="txtDateReceived" runat="server" CssClass="default" Width="100" MaxLength="10" />
                                                                    <asp:ImageButton ID="imgbtnDateReceived" runat="server" ImageAlign="AbsMiddle" ImageUrl="/images/calendar.gif" />
                                                                </td>
                                                            </tr> 
                                                            <tr valign="top">
                                                                <td nowrap>Path:</td>
                                                            ...
                                                            <tr valign="top">
                                                                <td>&nbsp;</td>
                                                                <td><asp:Button ID="btnUpload" runat="server" CssClass="default" Text="Upload" Width="75" OnClick="btnUpload_Click" />
                                                                    <asp:HiddenField ID="hdnOrderId" runat="server" />
                                                                    <asp:HiddenField ID="hdnModel" runat="server" />
                                                                    <asp:HiddenField ID="hdnProcureQuantity" runat="server" />
                                                                </td>
                                                            </tr>
                                                            <tr valign="top">
                                                                <td>&nbsp;</td>
                                                            ...
                                                            <tr valign="top" >
                                                                <td colspan="2"><asp:Label ID="lblAssetSelection" runat="server" CssClass="default" Text="<b>Select the Asset(s) to Check in against this purchase order</b>" /></td>
                                                            </tr>
                                                            <tr valign="top">
                                                            <td colspan="2">
                                                                ...
                                                                <table width="100%" cellpadding="2" cellspacing="2" border="1">
                                                                    <tr valign="top"><td>
                                                                        <asp:Panel ID="pnlAssetList" runat="server" Visible="true"   height="400" ScrollBars="Auto" >
                                                                             <asp:DataList ID="dlAssetList" runat="server" CellPadding="3" CellSpacing="1" Width="100%" OnItemDataBound="dlAssetList_ItemDataBound">
                                                                                <HeaderTemplate>
                                                                                    <tr bgcolor="#EEEEEE">
                                                                                        <td align="left" width="1%">
                                                                                            <input type="checkbox" id="chkAssetListHeaderSelectAll" onclick="CheckUnCheckAll(this);" runat="server" name="chkAssetListHeaderSelectAll">
                                                                                        </td>
                                                                                        <td align="left" width="10%">
                                                                                            <asp:Label ID="lblAssetListHeaderSerialNo" runat="server" CssClass="default" Text="<b>Serial Number</b>"  />
                                                                                        </td>
                                                                                        <td align="left" width="10%">
                                                                                            <asp:Label ID="lblAssetListHeaderAssetTag" runat="server" CssClass="default" Text="<b>Asset Number</b>"  />
                                                                                        </td>
                                                                                        <td align="left" nowrap>
                                                                                            <asp:Label ID="lblAssetListHeaderAssetScanDateTime" runat="server" CssClass="default" Text="<b>Scan Date Time</b>"  />
                                                                                        </td>
                                                                                        <td align="left" width="1%">
                                                                                            <asp:Label ID="lblAssetListHeaderReturn" runat="server" CssClass="default" Text="<b>Return</b>"  />
                                                                                        </td>
                                                                                        <td align="left" width="100%">
                                                                                            <asp:Label ID="lblAssetListHeaderComments" runat="server" CssClass="default" width="98%" Text="<b>Comments</b>" />
                                                                                        </td>
                                                                                    </tr>
                                                                                </HeaderTemplate>
                                                                                <ItemTemplate>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left" >
                                                                                            ...
                                                                                            <asp:Label ID="lblAssetListSerialNo" runat="server" CssClass="default" />
                                                                                        </td>
                                                                                        <td align="left" >
                                                                                            <asp:Label ID="lblAssetListAssetTag" runat="server" CssClass="default" />
                                                                                        </td>
                                                                                        <td align="left" nowrap>
                                                                                            <asp:Label ID="lblAssetListAssetScanDateTime" runat="server" CssClass="default" />
                                                                                        </td>
                                                                                        <td align="left" >
                                                                                            <asp:CheckBox ID="chkAssetReturn" runat="server" />
                                                                                        </td>
                                                                                        <td align="left" >
                                                                                            <asp:TextBox ID="txtAssetListComments" runat="server" CssClass="default" Width="98%"  />
                                                                                        </td>
                                                                                    </tr>
                                                                                </ItemTemplate>
                                                                                <AlternatingItemTemplate>
