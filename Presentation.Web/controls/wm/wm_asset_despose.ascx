<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wm_asset_despose.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.wm_asset_despose" %>
		                                        ...
		                                        <br />
                                                    ...
                                                    <br />
		                                             ...
		                                             <asp:Panel ID="pnlExecution" runat="server" Visible="true">
                                                            ...
                                                            <asp:HiddenField ID="hdnRequestedQuantity" runat="server" />
                                                            
                                                            <table id="tblDepot" width="100%" cellpadding="4" cellspacing="3" border="0">
                                                                <tr id="trLocation" runat="server" valign="top">
                                                                    <td nowrap>
                                                                    <asp:Label ID="lblLocation" runat="server" CssClass="default" Text="Disposal depot :<font class='required'>&nbsp;*</font>" />
                                                                    </td><td width="100%">
                                                                        ...
                                                                        <asp:Panel ID="pnlAssetList" runat="server" Visible="true"   height="400" ScrollBars="Auto" >
                                                                             <asp:DataList ID="dlAssetList" runat="server" CellPadding="3" CellSpacing="1" Width="100%" OnItemDataBound="dlAssetList_ItemDataBound">
                                                                                <HeaderTemplate>
                                                                                    <tr bgcolor="#EEEEEE" valign="top">
                                                                                        <td align="left" width="1%">
                                                                                            <asp:Label ID="lblAssetListHeaderNo" runat="server" CssClass="default" Text=""  />
                                                                                        </td>
                                                                                        <td align="left" width="10%">
                                                                                            <asp:Label ID="lblAssetListHeaderSerialNo" runat="server" CssClass="default" Text="<b>Serial Number</b>"  />
                                                                                        </td>
                                                                                        <td align="left" width="10%">
                                                                                            <asp:Label ID="lblAssetListHeaderAssetTag" runat="server" CssClass="default" Text="<b>Asset Tag</b>"  />
                                                                                        </td>
                                                                                        <td align="left" width="1%">
                                                                                            <asp:Label ID="lblAssetListHeaderReturn" runat="server" CssClass="default" Text="<b>Asset Returned?</b>"  />
                                                                                        </td>
                                                                                        <td align="left" width="1%">
                                                                                            <asp:Label ID="lblAssetListHeaderStatus" runat="server" CssClass="default" Text="<b>Status</b>"  />
                                                                                        </td>
                                                                                        <td align="left" width="100%">
                                                                                            <asp:Label ID="lblAssetListHeaderComments" runat="server" CssClass="default" width="98%" Text="<b>Required Dispose Attributes</b>" />
                                                                                        </td>
                                                                                        <td align="left" nowrap >
                                                                                            <asp:Label ID="lblAssetListHeaderEdit" runat="server" CssClass="default" Text="<b>Configure</b>" />
                                                                                        </td>
                                                                                ...
                                                                                <ItemTemplate>
                                                                                    <tr valign="top">
                                                                                        <td align="left" >
                                                                                            <asp:Label ID="lblAssetListNo" runat="server" CssClass="default" Text=""  />
                                                                                        </td>
                                                                                        <td align="left" >
                                                                                            <asp:HiddenField ID="hdnAssetId" runat="server" />
                                                                                            <asp:HiddenField ID="hdnScanDateTime" runat="server" />
                                                                                            <asp:LinkButton ID="lnkbtnAssetListSerialNo" runat="server" CssClass="lookup" />
                                                                                        </td>
                                                                                        <td align="left" >
                                                                                        ...
                                                                                        <td align="left" >
                                                                                         ...
                                                                                         <td align="left" >
                                                                                            <asp:Label ID="lblAssetListStatus" runat="server" CssClass="default" />
                                                                                        </td>
                                                                                        <td align="left" >
                                                                                           <asp:Label ID="lblAssetListComments" runat="server" CssClass="default" />
                                                                                        </td>
                                                                                        <td align="left" nowrap>
                                                                                             <asp:LinkButton ID="lnkbtnAssetListEdit" runat="server" ToolTip="Configure"  Text="Configure" CssClass="lookup" />
                                                                                        </td>
                                                                                    </tr>
                                                                                </ItemTemplate>
                                                                                <AlternatingItemTemplate>
