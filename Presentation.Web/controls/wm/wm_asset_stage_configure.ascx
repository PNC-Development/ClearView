<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wm_asset_stage_configure.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.wm_asset_stage_configure" %>
                                                                             ...
                                                                             <asp:DataList ID="dlAssetList" runat="server" CellPadding="3" CellSpacing="1" Width="100%" OnItemDataBound="dlAssetList_ItemDataBound">
                                                                                <HeaderTemplate>
                                                                                    <tr bgcolor="#EEEEEE" valign="top">
                                                                                        ...
                                                                                        <td align="left" width="100%">
                                                                                            <asp:Label ID="lblAssetListHeaderComments" runat="server" CssClass="default" width="98%" Text="<b>Required Staging and Configuration Attributes</b>" />
                                                                                        </td>
                                                                                        <td align="left" nowrap >
                                                                                ...
                                                                                <ItemTemplate>
                                                                                    <tr valign="top">
                                                                                        ...
                                                                                        <td align="left" nowrap>
                                                                                             <asp:LinkButton ID="lnkbtnAssetListEdit" runat="server" ToolTip="Stage and Configure Asset"  Text="Configure" CssClass="lookup" />
                                                                                        </td>
                                                                                    </tr>
                                                                                </ItemTemplate>
                                                                                <AlternatingItemTemplate>
