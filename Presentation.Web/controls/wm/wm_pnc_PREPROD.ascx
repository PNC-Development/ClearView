<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wm_pnc_PREPROD.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.wm_pnc_PREPROD" %>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <table cellpadding="2" cellspacing="1" border="0">
                                                                <asp:Panel ID="panSAV" runat="server" Visible="false">
                                                                    <tr>
                                                                        <td><asp:CheckBox ID="chkSAV" runat="server" CssClass="default" Text="SVC, ESM(PNC)" /></td>
                                                                    </tr>
                                                                </asp:Panel>
                                                               <asp:Panel ID="panHIDS" runat="server" Visible="false">
                                                                    <tr>
                                                                        <td><asp:CheckBox ID="chkHIDS" runat="server" CssClass="default" Text="Hids(PNC)" /></td>
                                                                    </tr>
                                                                </asp:Panel>
                                                                <asp:Panel ID="panECM" runat="server" Visible="false">
                                                                    <tr>
                                                                        <td><asp:CheckBox ID="chkECM" runat="server" CssClass="default" Text="ECM(PNC)" /></td>
                                                                    </tr>
                                                                </asp:Panel>
                                                                <asp:Panel ID="panNetIQ" runat="server" Visible="false">
                                                                    <tr>
                                                                        <td><asp:CheckBox ID="chkNetIQ" runat="server" CssClass="default" Text="NetIQ(PNC)" /></td>
                                                                    </tr>
                                                                </asp:Panel>
                                                               
                                                                 <asp:Panel ID="panAudit" runat="server" Visible="false">
                                                                    <tr>
                                                                        <td><asp:CheckBox ID="chkAudit" runat="server" CssClass="default" Text="Audit(PNC)" /></td>
                                                                    </tr>
                                                                </asp:Panel>
