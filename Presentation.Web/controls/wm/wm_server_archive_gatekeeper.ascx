<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wm_server_archive_gatekeeper.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.wm_server_archive_gatekeeper" %>
                                    ...
                                    <tr> 
                                        <td valign="top">
		                                    ...
		                                    <div id="divExecution" style='<%=boolExecution == true ? "display:inline" : "display:none" %>'>
                                                ...
                                                <table width="100%" cellpadding="4" cellspacing="3" border="0">
                                                    <tr>
                                                        <td colspan="2" class="greentableheader">Gatekeeper Tasks</td>
                                                    </tr>
                                                    <tr>
                                                        <td><asp:CheckBox ID="chkG1" runat="server" CssClass="default" /></td>
                                                        <td width="100%">Execute the &quot;<b>Create VS Guest from Existing Server</b>&quot; wizard within Asset Center. <span class="note">Note:</span> If VS guest already exists disregard this step and check the box.</td>
                                                    </tr>
                                                    <tr>
                                                        <td><asp:CheckBox ID="chkG2" runat="server" CssClass="default" /></td>
                                                        <td width="100%">Within Asset Center make the server guest & host correlation under: Portfolio Tab/ General Tab/ Component of: <span class="bluenote">1 HP HP PROLIANT DL380 G4 (NCC313879:431718060023291437961)</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><asp:CheckBox ID="chkG3" runat="server" CssClass="default" /></td>
                                                        <td width="100%">Within Asset Center select &quot;<b>Archived</b>&quot; from the Computer Type: drop down under Computer Tab/ Device Info Tab.</td>
                                                    </tr>
                                                    <tr>
                                                        <td><asp:CheckBox ID="chkG4" runat="server" CssClass="default" /></td>
                                                        <td width="100%">Within Asset Center check &quot;<b>Test Loaner</b>&quot; field under: Portfolio Tab/ Computer Tab / Device Info Tab. <span class="note">Note:</span> If VS guest disregard this step and check the box.</td>
                                                    </tr>
                                                    <tr>
                                                        <td><asp:CheckBox ID="chkG5" runat="server" CssClass="default" /></td>
                                                        <td width="100%">Within Asset Center uncheck the &quot;<b>Billable</b>&quot; field under: Portfolio Tab/Charge Information Tab.</td>
                                                    </tr>
                                                    <tr>
                                                        <td><asp:CheckBox ID="chkG6" runat="server" CssClass="default" /></td>
                                                        <td width="100%">Submit a decommission request via Service Center to have the physical asset removed and stored. <span class="note">Note:</span> If VS guest disregard this step and check the box.</td>
                                                    </tr>
                                                </table>
                                                <table width="100%" cellpadding="4" cellspacing="3" border="0">
                                                    <tr>
