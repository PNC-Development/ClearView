<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wm_server_archive_test_center.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.wm_server_archive_test_center" %>
                                        ...
                                        <td valign="top">
		                                    ...
		                                    <div id="divExecution" style='<%=boolExecution == true ? "display:inline" : "display:none" %>'>
                                                ...
                                                <table width="100%" cellpadding="4" cellspacing="3" border="0">
                                                    ...
                                                    <tr>
                                                        <td><asp:CheckBox ID="chkT1" runat="server" CssClass="default" /></td>
                                                        <td width="100%">Archive physical server to the designated archive host/library [<a href="/help/Server Archive and Retrieval Procedures DRAFT.pdf" target="_blank">Click here for instructions</a>]</td>
                                                    </tr>
                                                    <tr>
                                                        <td><asp:CheckBox ID="chkT2" runat="server" CssClass="default" /></td>
                                                        <td width="100%">Power down the physical server</td>
                                                    </tr>
                                                    <tr>
                                                        <td><asp:CheckBox ID="chkT3" runat="server" CssClass="default" /></td>
                                                        <td width="100%">Clearly label the physical server as &quot;<b>Archived</b>&quot;</td>
                                                    </tr>
                                                </table>
                                                <table width="100%" cellpadding="4" cellspacing="3" border="0">
                                                    <tr>
