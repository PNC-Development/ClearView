<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wm_server_decommission_additional.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.wm_server_decommission_additional" %>
...
<script type="text/javascript">
    ...
    function ValidateStorage(oDate1, oDate2, oCR2, oAmount, oClassM, oClassL, oVendorE, oVendorH, oDatacenter, oArray) {
        if (ValidateDate(oDate1, 'Please enter a valid pre cool down date') == false)
            return false;
        else {
            if (ValidateDate(oDate2, 'Please enter a valid cool down date') == false)
                return false;
            else {
                if (ValidateText(oCR2, 'Please enter a storage CR2 number for phase II work') == false)
                    return false;
                else {
                    if (ValidateNumber0(oAmount, 'Please enter a valid amount') == false)
                        return false;
                    else {
                        if (ValidateRadioButtons(oClassM, oClassL, 'Please select the reclaimed storage classification') == false)
                            return false;
                        else {
                            oClassM = document.getElementById(oClassM);
                            if (oClassM.checked == true) {
                                if (ValidateRadioButtons(oVendorE, oVendorH, 'Please select the vendor platform') == false)
                                    return false;
                                else {
                                    if (ValidateDropDown(oDatacenter, 'Please select the data center location') == false)
                                        return false;
                                    else {
                                        if (ValidateText(oArray, 'Please enter an array serial number') == false)
                                            return false;
                                    }
                                }
                            }
                                        ...
                                        <td valign="top">
		                                    ...
		                                    <div id="divExecution" style='<%=boolExecution == true ? "display:inline" : "display:none" %>'>
                                                ...
                                                <table width="100%" cellpadding="4" cellspacing="3" border="0">
                                                    ...
                                                    <tr>
                                                        <td nowrap>Amount Reclaimed:</td>
                                                        <td width="100%"><asp:TextBox ID="txtBackup" runat="server" CssClass="default" Width="100" MaxLength="10" /> GB <asp:Label ID="lblBackup" runat="server" CssClass="default" /></td>
                                                    </tr>
                                                    </asp:Panel>
                                                    <asp:Panel ID="panStorage" runat="server" Visible="false">
                                                    <tr>
                                                        <td nowrap>Pre cool down date:</td>
                                                        <td width="100%"><asp:TextBox ID="txtPreCooldown" runat="server" CssClass="default" Width="100" MaxLength="10" /> <asp:ImageButton ID="imgPreCooldown" runat="server" ImageAlign="AbsMiddle" ImageUrl="/images/calendar.gif" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td nowrap>Cool down date:</td>
                                                        <td width="100%"><asp:TextBox ID="txtCooldown" runat="server" CssClass="default" Width="100" MaxLength="10" /> <asp:ImageButton ID="imgCooldown" runat="server" ImageAlign="AbsMiddle" ImageUrl="/images/calendar.gif" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td nowrap>Storage CR2 number for phase II work:</td>
                                                        <td width="100%"><asp:TextBox ID="txtCR2" runat="server" CssClass="default" Width="200" MaxLength="50" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td nowrap>Amount of Storage Reclaimed:</td>
                                                        <td width="100%"><asp:TextBox ID="txtStorage" runat="server" CssClass="default" Width="100" MaxLength="10" /> GB <asp:Label ID="lblStorage" runat="server" CssClass="default" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td nowrap>Reclaimed Storage Classification:</td>
                                                        <td width="100%">
                                                            <asp:RadioButton ID="radClassificationM" runat="server" Text="Mainstream - EMC VMAX or Hitachi VSP" GroupName="radClassification" /><br />
                                                            <asp:RadioButton ID="radClassificationL" runat="server" Text="Legacy - Everything Else (IBM, HP, Legacy EMC)" GroupName="radClassification" /><br />
                                                        </td>
                                                    </tr>
                                                    <tr id="trMainstream1" runat="server" style="display:none">
                                                        <td nowrap>Specify vendor platform:</td>
                                                        <td width="100%">
                                                            <asp:RadioButton ID="radVendorE" runat="server" Text="EMC VMAX" GroupName="radVendor" /> 
                                                            <asp:RadioButton ID="radVendorH" runat="server" Text="Hitachi VSP" GroupName="radVendor" />
                                                        </td>
                                                    </tr>
                                                    <tr id="trMainstream2" runat="server" style="display:none">
                                                        <td nowrap>Specify data center location:</td>
                                                        <td width="100%">
                                                            <asp:DropDownList ID="ddlLocation" runat="server" Width="100">
                                                                <asp:ListItem Text="-- SELECT --" Value="0" />
                                                                <asp:ListItem Text="Summit" Value="1675" />
                                                                <asp:ListItem Text="Firstside" Value="1674" />
                                                                <asp:ListItem Text="CLEOPS" Value="715" />
                                                                <asp:ListItem Text="Dalton" Value="696" />
                                                                <asp:ListItem Text="Midland" Value="7012" />
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr id="trMainstream3" runat="server" style="display:none">
                                                        <td nowrap>Specify array serial number:</td>
                                                        <td width="100%"><asp:TextBox ID="txtSerial" runat="server" CssClass="default" Width="75" MaxLength="5" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td nowrap>Additional Notes:</td>
                                                        <td width="100%"><asp:TextBox ID="txtNotes" runat="server" CssClass="default" Width="300" TextMode="MultiLine" Rows="5" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">&nbsp;</td>
                                                    </tr>
...
<asp:Label ID="lblStorageAmt" runat="server" Visible="false" />
<asp:Label ID="lblStorageTier" runat="server" Visible="false" />
<asp:Label ID="lblStorageEnvironment" runat="server" Visible="false" />
