<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wm_shared_env_add_cluster.ascx.cs" Inherits="NCC.ClearView.Presentation.Web.wm_shared_env_add_cluster" %>
                                                                        ...
                                                                        <HeaderTemplate>
                                                                            <tr bgcolor="#EEEEEE" valign="top">
                                                                                ...
                                                                                <td align="left" width="100%">
                                                                                    <asp:Label ID="lblAssetListHeaderComments" runat="server" CssClass="default" width="98%" Text="<b>Required Tasks Status</b>" />
                                                                                </td>
                                                                                <td align="left" nowrap >
                                                                                    <asp:Label ID="lblAssetListHeaderEdit" runat="server" CssClass="default" Text="<b>Configure Device</b>" />
                                                                                </td>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <tr valign="top">
                                                                               ...
                                                                               <td align="left" >
                                                                                ...
                                                                                <td align="left" nowrap>
                                                                                     <asp:LinkButton ID="lnkbtnAssetListEdit" runat="server" ToolTip="Configure Device" Text="Configure Device" CssClass="lookup" />
                                                                                </td>
                                                                            </tr>
                                                                        </ItemTemplate>
