<%@ Page Language="C#" MasterPageFile="~/datapoint.Master" AutoEventWireup="true" CodeBehind="blade_deploy.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.blade_deploy" Title="Untitled Page" %>
        ...
        <tr>
            ...
            <td width="100%" rowspan="2" align="right">
                <table cellpadding="1" cellspacing="4" border="0">
                    ...
                    <tr>
                        <td colspan="7" class="bigError" align="center"><img src="/images/bigError.gif" border="0" align="absmiddle" /> Deploy Not Successful</td>
                    </tr>
                    </asp:Panel>
                </table>
            </td>
                    ...
                    <div style="display:none">
                        <table width="100%" cellpadding="5" cellspacing="2" border="0">
                            ...
                            <tr>
                                ...
                                <td width="100%"><asp:Label ID="lblPlatformILO" runat="server" CssClass="default" /><asp:TextBox ID="txtPlatformILO" runat="server" CssClass="default" MaxLength="15" Width="200" /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="100%"><asp:Label ID="lblPlatformMAC" runat="server" CssClass="default" /><asp:TextBox ID="txtPlatformMAC" runat="server" CssClass="default" MaxLength="50" Width="300" /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="100%"><asp:Label ID="lblEnclosure" runat="server" CssClass="default" /><asp:DropDownList ID="ddlEnclosure" runat="server" CssClass="default" Width="400" /></td>
                            </tr>
                            <tr>
                                <td nowrap><asp:Label ID="fldEnclosureSlot" runat="server" CssClass="default" Text="Slot:" /></td>
                                <td width="100%"><asp:Label ID="lblEnclosureSlot" runat="server" CssClass="default" /><asp:TextBox ID="txtEnclosureSlot" runat="server" CssClass="default" MaxLength="2" Width="50" /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="100%" class="required"><asp:DropDownList ID="ddlPlatformStatus" runat="server" CssClass="default" />&nbsp;&nbsp;Default: In Stock</td>
                            </tr>
                        </table>
                    </div>
                    <div style="display:none">
