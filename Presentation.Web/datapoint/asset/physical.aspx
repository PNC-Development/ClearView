<%@ Page Language="C#" MasterPageFile="~/datapoint.Master" AutoEventWireup="true" CodeBehind="physical.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.physical" Title="Untitled Page" %>
                ...
                <div id="divMenu1" class="tabbing">
                    ...
                    <div id="divNetworkAdapter" runat="server" visible="false" style="display:none">
                        <table width="100%" cellpadding="5" cellspacing="2" border="0">
                            ...
                            <tr>
                                <td nowrap valign="top"><asp:Label ID="lblNetworkSwitch1" runat="server" CssClass="default" /></td>
                                <td nowrap valign="top"><asp:Label ID="lblNetworkBlade1" runat="server" CssClass="default" /></td>
                                <td valign="top"><asp:Label ID="lblNetworkPort1" runat="server" CssClass="default" /></td>
                                <td valign="top"><asp:Label ID="lblNetworkInterface1" runat="server" CssClass="default" /></td>
                            </tr>
                            <tr>
                                <td nowrap valign="top"><asp:Label ID="lblNetworkSwitch2" runat="server" CssClass="default" /></td>
                                <td nowrap valign="top"><asp:Label ID="lblNetworkBlade2" runat="server" CssClass="default" /></td>
                                <td valign="top"><asp:Label ID="lblNetworkPort2" runat="server" CssClass="default" /></td>
                                <td valign="top"><asp:Label ID="lblNetworkInterface2" runat="server" CssClass="default" /></td>
                            </tr>
                            <tr>
                                <td colspan="10"><asp:Button ID="btnNetworkAdapter" runat="server" CssClass="default" Width="100" Text="Manage" Visible="false" /></td>
                            </tr>
                        </table>
                    </div>
                    <div id="divNexus" runat="server" visible="false" style="display:none">
                        <table cellpadding="5" cellspacing="2" border="0">
                            ...
                            <tr>
                                <td nowrap valign="top" class="tableheader">Network (A):</td>
                                <td nowrap valign="top"><asp:Label ID="lblSwitchNetworkA" runat="server" CssClass="default" /></td>
                                <td nowrap valign="top"><asp:Label ID="lblInterfaceNetworkA" runat="server" CssClass="default" /></td>
                                <td valign="top"><asp:Label ID="lblConfigNetworkA" runat="server" CssClass="default" /></td>
                            </tr>
                            <tr>
                                <td nowrap valign="top" class="tableheader">Network (B):</td>
                                <td nowrap valign="top"><asp:Label ID="lblSwitchNetworkB" runat="server" CssClass="default" /></td>
                                <td nowrap valign="top"><asp:Label ID="lblInterfaceNetworkB" runat="server" CssClass="default" /></td>
                                <td valign="top"><asp:Label ID="lblConfigNetworkB" runat="server" CssClass="default" /></td>
                            </tr>
                            <tr id="panNexusRemote" runat="server" visible="false">
                                <td nowrap valign="top" class="tableheader">Remote Mgmt:</td>
                                <td nowrap valign="top"><asp:Label ID="lblSwitchRemote" runat="server" CssClass="default" /></td>
                                <td nowrap valign="top"><asp:Label ID="lblInterfaceRemote" runat="server" CssClass="default" /></td>
                                <td valign="top"><asp:Label ID="lblConfigRemote" runat="server" CssClass="default" /></td>
                            </tr>
                            <tr id="panNexusBackup" runat="server" visible="false">
                                <td nowrap valign="top" class="tableheader">Backup:</td>
                                <td nowrap valign="top"><asp:Label ID="lblSwitchBackup" runat="server" CssClass="default" /></td>
                                <td nowrap valign="top"><asp:Label ID="lblInterfaceBackup" runat="server" CssClass="default" /></td>
                                <td valign="top"><asp:Label ID="lblConfigBackup" runat="server" CssClass="default" /></td>
                            </tr>
                            <tr id="panNexusClusterA" runat="server" visible="false">
                                <td nowrap valign="top" class="tableheader">Cluster (A):</td>
                                <td nowrap valign="top"><asp:Label ID="lblSwitchClusterA" runat="server" CssClass="default" /></td>
                                <td nowrap valign="top"><asp:Label ID="lblInterfaceClusterA" runat="server" CssClass="default" /></td>
                                <td valign="top"><asp:Label ID="lblConfigClusterA" runat="server" CssClass="default" /></td>
                            </tr>
                            <tr id="panNexusClusterB" runat="server" visible="false">
                                <td nowrap valign="top" class="tableheader">Cluster (B):</td>
                                <td nowrap valign="top"><asp:Label ID="lblSwitchClusterB" runat="server" CssClass="default" /></td>
                                <td nowrap valign="top"><asp:Label ID="lblInterfaceClusterB" runat="server" CssClass="default" /></td>
                                <td valign="top"><asp:Label ID="lblConfigClusterB" runat="server" CssClass="default" /></td>
                            </tr>
                            ...
                            <tr>
                                <td></td>
                                <td colspan="10"><asp:Button ID="btnNexusAdapter" runat="server" CssClass="default" Width="100" Text="Manage" Visible="false" /></td>
                            </tr>
                        </table>
                    </div>
                    <div style="display:none">
                                ...
                                <td nowrap colspan="2">
                                    <asp:Panel ID="panAdministration" runat="server" Visible="false">
                                        <table width="100%" cellpadding="5" cellspacing="2" border="0">
                                            ...
                                            <tr>
                                                <td class="header" colspan="2"><asp:Label ID="fldNexusAdapter" runat="server" CssClass="header" Text="Nexus Adapter Configuration" /></td>
                                            </tr>
                                        </table>
                                    </asp:Panel>
                                </td>
