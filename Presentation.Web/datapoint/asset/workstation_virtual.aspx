<%@ Page Language="C#" MasterPageFile="~/datapoint.Master" AutoEventWireup="true" CodeBehind="workstation_virtual.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.workstation_virtual" Title="Untitled Page" %>
            ...
            <td valign="top">
                <div id="divMenu1" class="tabbing">
                    ...
                    <div style="display:none">
                        <table width="100%" cellpadding="5" cellspacing="2" border="0">
                            <tr>
                                <td class="header" colspan="2"><asp:Label ID="fldHostQuery" runat="server" CssClass="header" Text="Host Information" /></td>
                            </tr>
                            <tr>
