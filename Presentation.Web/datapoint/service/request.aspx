<%@ Page Language="C#" MasterPageFile="~/datapoint.Master" AutoEventWireup="true" CodeBehind="request.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.request" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="AllContent" runat="server">
    ...
    <br />
     ...
     <!-- Request Information -->
      <div id="divReqInfo" > 
      <table id="tblReqInfo" width="100%" cellpadding="2" cellspacing="2" border="0">
       <tr>
         <td  class="header"  colspan="2">Request Information&nbsp;&nbsp;<asp:Label ID="lblRequestID" runat="server" CssClass="header" /></td>
        <tr>
            <td>
                <table width="100%" cellpadding="2" cellspacing="2" border="0">
                    <tr >
                        <td width="20%"><asp:Label ID="fldRequestBy" runat="server" CssClass="default" Text="Requested By" /></td>
                        <td width="30%"><asp:Label ID="lblRequestBy" runat="server" CssClass="default" />
                         ...
                         <td width="20%"><asp:Label ID="fldRequestOn" runat="server" CssClass="default" Text="Requested On" /></td>
                         <td width="30%"><asp:Label ID="lblRequestOn" runat="server" CssClass="default" /><asp:TextBox ID="txtRequestOn" runat="server" CssClass="default" MaxLength="50" Width="200" /> <asp:ImageButton ID="imgRequestOn" runat="server" ImageAlign="AbsMiddle" ImageUrl="/images/calendar.gif" Visible="false" /></td>          
                    </tr>
                    <tr>
                        <td width="20%"><asp:Label ID="fldProjectNumber" runat="server" CssClass="default" Text="Project Number:" /></td>
                        <td width="30%"><asp:Label ID="lblProjectNumber" runat="server" CssClass="default" /><asp:TextBox ID="txtProjectNumber" runat="server" CssClass="default" MaxLength="30" Width="200" /> <asp:Button ID="btnProjectName" runat="server" CssClass="default" Width="75" Text="Lookup" Visible="false" /></td>
                        <td width="20%"><asp:Label ID="fldProjectName" runat="server" CssClass="default" Text="Project Name:" /></td>
                        <td width="30%"><asp:Label ID="lblProjectName" runat="server" CssClass="default" /><asp:TextBox ID="txtProjectName" runat="server" CssClass="default" MaxLength="50" Width="300" /></td>
                    </tr>
                    <tr>
                        <td width="20%"><asp:Label ID="fldStatus" runat="server" CssClass="default" Text="Request Status:" /></td>
                        <td width="30%"><asp:Label ID="lblStatus" runat="server" CssClass="default" /><asp:DropDownList ID="ddlStatus" runat="server" CssClass="default" Width="200" /></td>
                        <td width="20%"></td>
                        <td width="30%"></td>
      ...
      <br />
      <div id="divServerInfo" > 
          <table id="tblServiceInfo" width="100%" cellpadding="2" cellspacing="2" border="0">
           <tr>
             <td class="header"  colspan="2">Service Request(s)</td>
           </tr>  
            <tr>
                <td>
                         <table width="100%" cellpadding="4" cellspacing="0" border="0" style="border:solid 1px #CCCCCC">
                            ...
                            <asp:repeater ID="rptServiceRequests" runat="server">
                                <ItemTemplate>
                                    ...
                                    <tr>
                                        <td valign="top"><asp:Button ID="btnView" runat="server" Text="View" CssClass="default" Width="50" title='ResourceID: <%# DataBinder.Eval(Container.DataItem, "resourceid") %>' CommandArgument='<%# DataBinder.Eval(Container.DataItem, "serviceid")%>' CommandName='<%# DataBinder.Eval(Container.DataItem, "created")%>' /></td>
                                        <td valign="top" width="5%" align="center" title='ServiceID: <%# DataBinder.Eval(Container.DataItem, "serviceid")%>'>
                                            <asp:LinkButton ID="btnNumber" runat="server" CssClass="lookup" Text='<%# DataBinder.Eval(Container.DataItem, "number")%>' CommandArgument='<%# DataBinder.Eval(Container.DataItem, "formid")%>' />
                                            <asp:Image ID="imgWorkflow" runat="server" Visible="false" ImageAlign="AbsMiddle" ImageUrl="/images/down_right.gif" />
                                        </td>
                                        <td valign="top" width="35%" nowrap title='Click here to view the details of this service'><asp:Label ID="lblDetails" runat="server" CssClass="default" Text='<%#DataBinder.Eval(Container.DataItem, "servicename").ToString() %>' /></td>
                                        ...
                                        <td valign="top" width="10%" nowrap><asp:Label ID="lblRequestStatus" runat="server" CssClass="default" /></td>
                                        <td valign="top" width="15%" nowrap><%# DataBinder.Eval(Container.DataItem, "created").ToString()%></td>
                                        <td valign="top" width="15%" nowrap><%# (DataBinder.Eval(Container.DataItem, "cancelled").ToString() == "" ? DataBinder.Eval(Container.DataItem, "created").ToString() : DataBinder.Eval(Container.DataItem, "cancelled").ToString())%></td>
                                        <td valign="top"><asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="default" Width="75" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "serviceid")%>' CommandName='<%# DataBinder.Eval(Container.DataItem, "number")%>' ToolTip='<%# DataBinder.Eval(Container.DataItem, "completed")%>' OnClick="btnCancel_Click" /></td>
      ...
      <br />
      <div id="divReqResult" runat ="server" >  
           <table id="tblReqResult" width="100%" cellpadding="2" cellspacing="2" border="0">
               <tr>
                 <td class="header"  class="greentableheader" colspan="2">Service Request Result(s)</td>
               </tr>
                <tr>
                    <td>
                        <table width="100%" cellpadding="4" cellspacing="0" border="0" style="border:solid 1px #CCCCCC">
                            <tr bgcolor="#EEEEEE">
                                ...
                                <td width="30%"><b>Last Updated On</b></td>
                            </tr>
                            <asp:repeater ID="rptResults" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <td width="70%"><%# DataBinder.Eval(Container.DataItem, "result").ToString() %></td>
                                        <td width="30%"><%# DataBinder.Eval(Container.DataItem, "modified").ToString() %></td>
                                    </tr>
                                </ItemTemplate>
                            </asp:repeater>
                            <tr>
