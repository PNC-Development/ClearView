<%@ Page Language="C#" MasterPageFile="~/datapoint.Master" AutoEventWireup="true" CodeBehind="requestOlder.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.requestOlder" Title="Untitled Page" %>
                         ...
                         <table width="100%" cellpadding="4" cellspacing="0" border="0" style="border:solid 1px #CCCCCC">
                            ...
                            <asp:repeater ID="rptServiceRequests" runat="server">
                                <ItemTemplate>
                                    ...
                                    <tr>
                                        <td valign="top"><asp:Button ID="btnView" runat="server" Text="View" CssClass="default" Width="50" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "serviceid")%>' /></td>
                                        <td valign="top" width="5%" align="center" title='ServiceID: <%# DataBinder.Eval(Container.DataItem, "serviceid")%>'><asp:LinkButton ID="btnNumber" runat="server" CssClass="lookup" Text='<%# DataBinder.Eval(Container.DataItem, "number")%>' /></td>
                                    ...
                                    <asp:repeater id="rptWorkflow" datasource='<%# ((DataRowView)Container.DataItem).Row.GetChildRows("relationship") %>' runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td valign="top"><asp:Button ID="btnView" runat="server" Text="View" CssClass="default" Width="50" title='ResourceID: <%# DataBinder.Eval(Container.DataItem, "[\"resourceid\"]") %>' CommandArgument='<%# DataBinder.Eval(Container.DataItem, "[\"serviceid\"]")%>' /></td>
                                                ...
                                                <td valign="top" width="15%" nowrap><%# (DataBinder.Eval(Container.DataItem, "[\"going\"]").ToString() == "0" ? "---" : (DataBinder.Eval(Container.DataItem, "[\"cancelled\"]").ToString() == "" ? DataBinder.Eval(Container.DataItem, "[\"modified\"]").ToString() : DataBinder.Eval(Container.DataItem, "[\"cancelled\"]").ToString()))%></td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:repeater>
                                </ItemTemplate>
