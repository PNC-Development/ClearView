<%@ Page Language="C#" MasterPageFile="~/frame.Master" AutoEventWireup="true" CodeBehind="enhancement_view.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.enhancement_view" Title="Untitled Page" %>
...
<table cellpadding="2" cellspacing="2" class="default">
    ...
    <tr>
        <td nowrap valign="top">Estimated Start Date:<font class="required">&nbsp;*</font></td>
    ...
    <tr>
        <td nowrap valign="top">Estimated End Date:<font class="required">&nbsp;*</font></td>
