<%@ Page Language="C#" MasterPageFile="~/frame.Master" AutoEventWireup="true" CodeBehind="backup_inclusion.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.backup_inclusion" Title="Untitled Page" %>
...
<table cellpadding="3" cellspacing="2" border="0">
    ...
    <tr>
        <td><asp:Button ID="btnAdd" runat="server" CssClass="default" Width="125" Text="Add Inclusion" OnClick="btnAdd_Click" /></td>
    </tr>
</table>
</asp:Content>
