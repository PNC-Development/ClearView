<%@ Page Language="C#" MasterPageFile="~/window.Master" AutoEventWireup="true" CodeBehind="config_workstation_virtual.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.config_workstation_virtual" Title="Untitled Page" %>
        ...
        <td>
            <table width="100%" cellpadding="0" cellspacing="5" border="0">
                <tr>
                    ...
                    <td class="header" width="100%" valign="bottom">Configure a Virtual Workstation</td>
                </tr>
                <tr>
                    <td width="100%" valign="top">Prepare your virtual workstation for build by completing the following questions.</td>
                </tr>
            </table>
        </td>
    </tr>
