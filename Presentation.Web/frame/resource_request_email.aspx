<%@ Page Language="C#" MasterPageFile="~/frame.Master" AutoEventWireup="true" CodeBehind="resource_request_email.aspx.cs" Inherits="NCC.ClearView.Presentation.Web.resource_request_email" Title="Untitled Page" %>
...
<table width="100%" height="100%" border="0" cellSpacing="2" cellPadding="4" class="default">
    ...
    <tr height="1">
        <td nowrap><b>Comments<br />(Optional):</b></td>
        <td width="100%"><asp:TextBox ID="txtComments" runat="server" TextMode="MultiLine" Width="400" Rows="5" /></td>
    </tr>
